 ...
 * </copyright>
 *
 * $Id: NonregSwitch.java,v 1.2 2009/05/14 13:53:15 sbouchet Exp $
 */
...
public class NonregSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NonregPackage.ECLIPSE_SUMMIT: {
				EclipseSummit eclipseSummit = (EclipseSummit)theEObject;
				T result = caseEclipseSummit(eclipseSummit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NonregPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NonregPackage.TALK: {
				Talk talk = (Talk)theEObject;
				T result = caseTalk(talk);
				if (result == null) result = caseDocumentedElement(talk);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NonregPackage.TOPIC: {
				Topic topic = (Topic)theEObject;
				T result = caseTopic(topic);
				if (result == null) result = caseDocumentedElement(topic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NonregPackage.SITE: {
				Site site = (Site)theEObject;
				T result = caseSite(site);
				if (result == null) result = caseNamedElement(site);
				if (result == null) result = caseDocumentedElement(site);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NonregPackage.ACCESS: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Eclipse Summit</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Eclipse Summit</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEclipseSummit(EclipseSummit object) {
		return null;
	}
