...
public class AbstractEnabledSampleBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if ((abstractEnabledSample != null) && (basePart != null)) { 
			cc.append(SetCommand.create(editingDomain, abstractEnabledSample, ReferencesPackage.eINSTANCE.getAbstractEnabledSample_Enabled(), basePart.getEnabled()));
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof AbstractEnabledSample) {
			AbstractEnabledSample abstractEnabledSampleToUpdate = (AbstractEnabledSample)source;
			abstractEnabledSampleToUpdate.setEnabled(new Boolean(basePart.getEnabled()).booleanValue());


			return abstractEnabledSampleToUpdate;
		}
		else
			return null;
	}
	...
	public void firePropertiesChanged(IPropertiesEditionEvent event) {
		if (!isInitializing()) {
			...
			if (ReferencesViewsRepository.AbstractEnabledSample.enabled == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, abstractEnabledSample, ReferencesPackage.eINSTANCE.getAbstractEnabledSample_Enabled(), event.getNewValue()));
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			EObject copy = EcoreUtil.copy(abstractEnabledSample);
