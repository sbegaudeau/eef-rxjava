...
public class EMFComboViewerSamplePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof EMFComboViewerSample) && (EMFComboViewerSamplePropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof EMFComboViewerSample) && (refinement == EMFComboViewerSamplePropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof EMFComboViewerSample) && ((EMFComboViewerSamplePropertiesEditionComponent.BASE_PART.equals(part) && refinement == EMFComboViewerSamplePropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof EMFComboViewerSample) {
			return new EMFComboViewerSamplePropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
