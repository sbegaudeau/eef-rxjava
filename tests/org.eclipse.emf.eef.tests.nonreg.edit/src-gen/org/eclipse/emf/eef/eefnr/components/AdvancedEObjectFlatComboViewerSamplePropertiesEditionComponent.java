...
public class AdvancedEObjectFlatComboViewerSamplePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(final Notification msg) {
				if (basePart == null)
					AdvancedEObjectFlatComboViewerSamplePropertiesEditionComponent.this.dispose();
				else {
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if ((advancedEObjectFlatComboViewerSample != null) && (basePart != null)) { 
			if (advancedEObjectFlatComboViewerSample.eGet(EefnrPackage.eINSTANCE.getAdvancedEObjectFlatComboViewerSample_AdvancedeobjectflatcomboviewerRequiredProperty()) == null || !advancedEObjectFlatComboViewerSample.eGet(EefnrPackage.eINSTANCE.getAdvancedEObjectFlatComboViewerSample_AdvancedeobjectflatcomboviewerRequiredProperty()).equals(basePart.getAdvancedeobjectflatcomboviewerRequiredProperty())) {
				cc.append(SetCommand.create(editingDomain, advancedEObjectFlatComboViewerSample, EefnrPackage.eINSTANCE.getAdvancedEObjectFlatComboViewerSample_AdvancedeobjectflatcomboviewerRequiredProperty(), basePart.getAdvancedeobjectflatcomboviewerRequiredProperty()));
			}
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			EObject copy = EcoreUtil.copy(advancedEObjectFlatComboViewerSample);
