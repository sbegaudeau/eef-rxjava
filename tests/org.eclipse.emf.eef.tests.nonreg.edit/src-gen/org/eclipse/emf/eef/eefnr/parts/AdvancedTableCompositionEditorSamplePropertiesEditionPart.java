...
public interface AdvancedTableCompositionEditorSamplePropertiesEditionPart {
	...
	/**
	 * Init the advancedtablecompositionROProperty
	 * @param current the current value
	 * @param containgFeature the feature where to navigate if necessary
	 * @param feature the feature to manage
	 */
	...
	/**
	 * Update the advancedtablecompositionROProperty
	 * @param newValue the advancedtablecompositionROProperty to update
	 * 
	 */
	public void updateAdvancedtablecompositionROProperty();

	/**
	 * Adds the given filter to the advancedtablecompositionROProperty edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the advancedtablecompositionROProperty table
	 * 
	 */
