 ...
 * 
 */
public class TotalSamplePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof TotalSample) && (EefnrPackage.eINSTANCE.getTotalSample() == eObject.eClass());
	}
