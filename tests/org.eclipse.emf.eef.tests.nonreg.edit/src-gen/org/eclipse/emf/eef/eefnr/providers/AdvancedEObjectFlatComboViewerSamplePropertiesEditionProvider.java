 ...
 */
public class AdvancedEObjectFlatComboViewerSamplePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof AdvancedEObjectFlatComboViewerSample) && (EefnrPackage.eINSTANCE.getAdvancedEObjectFlatComboViewerSample() == eObject.eClass());
	}
