 ...
 * 
 */
public class ReferencesMessages extends NLS {
	
	private static final String BUNDLE_NAME = "org.eclipse.emf.eef.eefnr.references.providers.referencesMessages"; //$NON-NLS-1$

	
	public static String ReferenceEnabledSamplePropertiesEditionPart_PropertiesGroupLabel;

	
	public static String AbstractEnabledSamplePropertiesEditionPart_EnabledPropertiesGroupLabel;
	...
	public static String ReferenceEnabledSample_Part_Title;

	
	public static String AbstractEnabledSample_ReadOnly;

	
	public static String AbstractEnabledSample_Part_Title;

	
	public static String AbstractSample_ReadOnly;
	...
	public static String AbstractEnabledSamplePropertiesEditionPart_EnabledLabel;
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, ReferencesMessages.class);
	}

	
	private ReferencesMessages() {
