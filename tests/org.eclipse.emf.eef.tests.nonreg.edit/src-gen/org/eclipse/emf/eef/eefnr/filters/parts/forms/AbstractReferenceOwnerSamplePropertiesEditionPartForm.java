 ...
 * 
 */
public class AbstractReferenceOwnerSamplePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, AbstractReferenceOwnerSamplePropertiesEditionPart {
	 ...
	 * 
	 */
	public AbstractReferenceOwnerSamplePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(FiltersMessages.AbstractReferenceOwnerSamplePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, FiltersMessages.AbstractReferenceOwnerSamplePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(FiltersViewsRepository.AbstractReferenceOwnerSample.Properties.name, FiltersViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AbstractReferenceOwnerSamplePropertiesEditionPartForm.this, FiltersViewsRepository.AbstractReferenceOwnerSample.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(FiltersViewsRepository.AbstractReferenceOwnerSample.Properties.name, FiltersViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createAbstractTargetReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.abstractTarget.setHelpText(propertiesEditionComponent.getHelpContent(FiltersViewsRepository.AbstractReferenceOwnerSample.Properties.abstractTarget, FiltersViewsRepository.FORM_KIND));
		...
		"abstractTarget", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AbstractReferenceOwnerSamplePropertiesEditionPartForm.this, FiltersViewsRepository.AbstractReferenceOwnerSample.Properties.abstractTarget,
	...
	protected void moveAbstractTarget(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AbstractReferenceOwnerSamplePropertiesEditionPartForm.this, FiltersViewsRepository.AbstractReferenceOwnerSample.Properties.abstractTarget, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		abstractTarget.refresh();
	}
	...
	protected void removeFromAbstractTarget(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AbstractReferenceOwnerSamplePropertiesEditionPartForm.this, FiltersViewsRepository.AbstractReferenceOwnerSample.Properties.abstractTarget, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		abstractTarget.refresh();
	}
