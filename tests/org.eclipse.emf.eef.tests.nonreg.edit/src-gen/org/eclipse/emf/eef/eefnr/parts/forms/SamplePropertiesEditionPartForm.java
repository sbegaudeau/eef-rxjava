...
public class SamplePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SamplePropertiesEditionPart {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SamplePropertiesEditionPartForm.this,
							EefnrViewsRepository.Sample.Properties.textRequiredProperty,
	...
	public void setTextRequiredProperty(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EefnrViewsRepository.Sample.Properties.textRequiredProperty);
	...
	public void setTextOptionalProperty(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EefnrViewsRepository.Sample.Properties.textOptionalProperty);
