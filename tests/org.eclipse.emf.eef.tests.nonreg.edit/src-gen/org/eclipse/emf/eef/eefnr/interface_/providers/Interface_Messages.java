 ...
 * 
 */
public class Interface_Messages extends NLS {
	
	private static final String BUNDLE_NAME = "org.eclipse.emf.eef.eefnr.interface_.providers.interface_Messages"; //$NON-NLS-1$


	
	public static String SimpleSample_ReadOnly;
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, Interface_Messages.class);
	}

	
	private Interface_Messages() {
