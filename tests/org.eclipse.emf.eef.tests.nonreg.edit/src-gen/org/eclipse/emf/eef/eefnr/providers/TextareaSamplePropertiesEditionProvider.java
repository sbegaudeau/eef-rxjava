 ...
 * 
 */
public class TextareaSamplePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof TextareaSample) && (EefnrPackage.eINSTANCE.getTextareaSample() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof TextareaSample) && (TextareaSamplePropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof TextareaSample) && (refinement == TextareaSamplePropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof TextareaSample) && ((TextareaSamplePropertiesEditionComponent.BASE_PART.equals(part) && refinement == TextareaSamplePropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof TextareaSample) {
			return new TextareaSamplePropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
