...
import org.eclipse.emf.eef.eefnr.navigation.providers.NamingMessages;
...
public class EventPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EventPropertiesEditionPart {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		eventStep
			.addStep(NamingViewsRepository.Event.Properties.class)
			.addStep(NamingViewsRepository.Event.Properties.name);
		...
		composer = new PartComposer(eventStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				if (key == NamingViewsRepository.Event.Properties.class) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(NamingMessages.EventPropertiesEditionPart_PropertiesGroupLabel);
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EventPropertiesEditionPartForm.this, NamingViewsRepository.Event.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.emf.eef.naming.parts.EventPropertiesEditionPart#getName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.emf.eef.naming.parts.EventPropertiesEditionPart#setName(String newValue)
	 * 
	 */
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(NamingViewsRepository.Event.Properties.name);
	...
	public String getTitle() {
		return NamingMessages.Event_Part_Title;
	}
