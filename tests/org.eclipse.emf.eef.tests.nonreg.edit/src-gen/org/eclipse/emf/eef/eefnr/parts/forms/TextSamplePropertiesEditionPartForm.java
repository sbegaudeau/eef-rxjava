...
public class TextSamplePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, TextSamplePropertiesEditionPart {
		...
		textRequiredProperty.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TextSamplePropertiesEditionPartForm.this, EefnrViewsRepository.TextSample.textRequiredProperty, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, textRequiredProperty.getText()));
			}
	...
	protected void createTextOptionalPropertyText(FormToolkit widgetFactory, Composite parent) {
		...
		textOptionalProperty.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TextSamplePropertiesEditionPartForm.this, EefnrViewsRepository.TextSample.textOptionalProperty, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, textOptionalProperty.getText()));
			}
