 ...
 * 
 */
public class MultiValuedEditorSamplePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof MultiValuedEditorSample) && (EefnrPackage.eINSTANCE.getMultiValuedEditorSample() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof MultiValuedEditorSample) && (MultiValuedEditorSamplePropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof MultiValuedEditorSample) && (refinement == MultiValuedEditorSamplePropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof MultiValuedEditorSample) && ((MultiValuedEditorSamplePropertiesEditionComponent.BASE_PART.equals(part) && refinement == MultiValuedEditorSamplePropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof MultiValuedEditorSample) {
			return new MultiValuedEditorSamplePropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
