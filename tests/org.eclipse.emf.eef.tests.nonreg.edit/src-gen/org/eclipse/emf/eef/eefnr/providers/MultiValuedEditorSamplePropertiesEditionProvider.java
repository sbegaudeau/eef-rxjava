...
public class MultiValuedEditorSamplePropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof MultiValuedEditorSample) 
					&& (EefnrPackage.Literals.MULTI_VALUED_EDITOR_SAMPLE == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			return toTest instanceof EObject && EefnrPackage.Literals.MULTI_VALUED_EDITOR_SAMPLE == ((EObject)toTest).eClass();
		}
