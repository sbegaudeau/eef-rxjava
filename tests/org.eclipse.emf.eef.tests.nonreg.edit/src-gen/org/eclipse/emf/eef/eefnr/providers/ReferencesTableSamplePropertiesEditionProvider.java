 ...
 * 
 */
public class ReferencesTableSamplePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof ReferencesTableSample) && (EefnrPackage.eINSTANCE.getReferencesTableSample() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof ReferencesTableSample) && (ReferencesTableSamplePropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof ReferencesTableSample) && (refinement == ReferencesTableSamplePropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof ReferencesTableSample) && ((ReferencesTableSamplePropertiesEditionComponent.BASE_PART.equals(part) && refinement == ReferencesTableSamplePropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof ReferencesTableSample) {
			return new ReferencesTableSamplePropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
