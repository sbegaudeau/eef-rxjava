...
public class SamplePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, SamplePropertiesEditionPart {
		...
		textRequiredProperty.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SamplePropertiesEditionPartImpl.this, EefnrViewsRepository.Sample.textRequiredProperty, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, textRequiredProperty.getText()));
			}
	...
	protected void createTextOptionalPropertyText(Composite parent) {
		...
		textOptionalProperty.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SamplePropertiesEditionPartImpl.this, EefnrViewsRepository.Sample.textOptionalProperty, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, textOptionalProperty.getText()));
			}
