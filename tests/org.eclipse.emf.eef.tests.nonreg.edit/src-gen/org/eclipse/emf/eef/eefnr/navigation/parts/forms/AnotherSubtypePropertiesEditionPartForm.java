 ...
 * 
 */
public class AnotherSubtypePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, AnotherSubtypePropertiesEditionPart {
	 ...
	 */
	public AnotherSubtypePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	protected Composite createAnotherSpecialisationGroup(FormToolkit widgetFactory, final Composite parent) {
		Section anotherSpecialisationSection = widgetFactory.createSection(parent, Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
		anotherSpecialisationSection.setText(NavigationMessages.AnotherSubtypePropertiesEditionPart_AnotherSpecialisationGroupLabel);
		GridData anotherSpecialisationSectionData = new GridData(GridData.FILL_HORIZONTAL);
		anotherSpecialisationSectionData.horizontalSpan = 3;
		anotherSpecialisationSection.setLayoutData(anotherSpecialisationSectionData);
		Composite anotherSpecialisationGroup = widgetFactory.createComposite(anotherSpecialisationSection);
		...
		anotherSpecialisationSection.setClient(anotherSpecialisationGroup);
