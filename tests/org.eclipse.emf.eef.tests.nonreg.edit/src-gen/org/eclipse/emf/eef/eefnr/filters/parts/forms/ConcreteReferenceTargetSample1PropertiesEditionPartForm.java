 ...
 * 
 */
public class ConcreteReferenceTargetSample1PropertiesEditionPartForm extends CompositePropertiesEditingPart implements FormPropertiesEditingPart, ConcreteReferenceTargetSample1PropertiesEditionPart {
	 ...
	 * 
	 */
	public ConcreteReferenceTargetSample1PropertiesEditionPartForm(PropertiesEditingComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(FiltersMessages.ConcreteReferenceTargetSample1PropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, FiltersMessages.ConcreteReferenceTargetSample1PropertiesEditionPart_NameLabel, propertiesEditingComponent.isRequired(FiltersViewsRepository.ConcreteReferenceTargetSample1.Properties.name, FiltersViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditingComponent != null)
					propertiesEditingComponent.firePropertiesChanged(new PropertiesEditingEventImpl(ConcreteReferenceTargetSample1PropertiesEditionPartForm.this, FiltersViewsRepository.ConcreteReferenceTargetSample1.Properties.name, PropertiesEditingEventImpl.COMMIT, PropertiesEditingEventImpl.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditingComponent.getHelpContent(FiltersViewsRepository.ConcreteReferenceTargetSample1.Properties.name, FiltersViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
