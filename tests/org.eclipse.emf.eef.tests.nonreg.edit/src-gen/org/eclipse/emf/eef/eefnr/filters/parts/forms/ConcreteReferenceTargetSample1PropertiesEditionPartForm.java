 ...
 * 
 */
public class ConcreteReferenceTargetSample1PropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ConcreteReferenceTargetSample1PropertiesEditionPart {
	 ...
	 */
	public ConcreteReferenceTargetSample1PropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ConcreteReferenceTargetSample1PropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		CompositionSequence concreteReferenceTargetSample1Step = new BindingCompositionSequence(propertiesEditionComponent);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ConcreteReferenceTargetSample1PropertiesEditionPartForm.this,
							FiltersViewsRepository.ConcreteReferenceTargetSample1.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConcreteReferenceTargetSample1PropertiesEditionPartForm.this, FiltersViewsRepository.ConcreteReferenceTargetSample1.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
