 ...
 * 
 */
public class NamingMessages extends NLS {
	
	private static final String BUNDLE_NAME = "org.eclipse.emf.eef.eefnr.navigation.providers.namingMessages"; //$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, NamingMessages.class);
	}

	
	private NamingMessages() {
