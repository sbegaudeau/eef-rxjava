 ...
 * 
 */
public interface DeferedReferencesTableSamplePropertiesEditionPart {
	...
	/**
	 * Init the referencesTableSampleEditor
	 * @param settings for the XXX ReferenceTable
	 */
	public void initReferencesTableSampleEditor(ReferencesTableSettings current);
	...
	/**
	 * @return true if the given element is contained inside the referencesTableSampleEditor table
	 * 
	 */
