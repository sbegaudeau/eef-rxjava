 ...
 * 
 */
public class RootPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Root) && (EefnrPackage.eINSTANCE.getRoot() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof Root) && (RootPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof Root) && (refinement == RootPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof Root) && ((RootPropertiesEditionComponent.BASE_PART.equals(part) && refinement == RootPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof Root) {
			return new RootPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
