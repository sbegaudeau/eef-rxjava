 ...
 * 
 */
public class ConcreteReferenceTargetSample2PropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ConcreteReferenceTargetSample2PropertiesEditionComponent(PropertiesEditingContext editingContext, EObject concreteReferenceTargetSample2, String editing_mode) {
		super(editingContext, concreteReferenceTargetSample2, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = FiltersViewsRepository.class;
		partKey = FiltersViewsRepository.ConcreteReferenceTargetSample2.class;
	}
	...
	protected EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == FiltersViewsRepository.ConcreteReferenceTargetSample2.Properties.name) {
