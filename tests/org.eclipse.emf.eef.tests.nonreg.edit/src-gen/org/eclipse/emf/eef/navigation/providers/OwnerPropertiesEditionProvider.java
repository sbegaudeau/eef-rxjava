...
public class OwnerPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Owner) 
					&& (NavigationPackage.eINSTANCE.getOwner() == editingContext.getEObject().eClass());
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof Owner) && (OwnerPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof Owner) && (refinement == OwnerPropertiesEditionComponent.class);
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof Owner) && ((OwnerPropertiesEditionComponent.BASE_PART.equals(part) && refinement == OwnerPropertiesEditionComponent.class));
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			return toTest instanceof EObject && NavigationPackage.eINSTANCE.getOwner() == ((EObject)toTest).eClass();
		}
