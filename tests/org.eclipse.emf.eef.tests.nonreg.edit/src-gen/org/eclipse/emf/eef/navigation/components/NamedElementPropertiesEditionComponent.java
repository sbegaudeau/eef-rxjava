 ...
 * 
 */
public class NamedElementPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public NamedElementPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject namedElement, String editing_mode) {
		super(editingContext, namedElement, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = NavigationViewsRepository.class;
		partKey = NavigationViewsRepository.NamedElement.class;
	}
