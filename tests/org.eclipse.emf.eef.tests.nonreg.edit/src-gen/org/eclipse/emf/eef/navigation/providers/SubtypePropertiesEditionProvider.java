...
public class SubtypePropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Subtype) 
					&& (NavigationPackage.Literals.SUBTYPE == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			return toTest instanceof EObject && NavigationPackage.Literals.SUBTYPE == ((EObject)toTest).eClass();
		}
