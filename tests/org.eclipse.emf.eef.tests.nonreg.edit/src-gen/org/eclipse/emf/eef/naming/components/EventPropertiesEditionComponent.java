 ...
 *******************************************************************************/
package org.eclipse.emf.eef.naming.components;
...
public class EventPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public EventPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject event, String editing_mode) {
		...
		repositoryKey = NamingViewsRepository.class;
		partKey = NamingViewsRepository.Event.class;
	}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == NamingViewsRepository.Event.Properties.name) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (NamingViewsRepository.Event.Properties.name == event.getAffectedEditor()) {
			event_.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	}
