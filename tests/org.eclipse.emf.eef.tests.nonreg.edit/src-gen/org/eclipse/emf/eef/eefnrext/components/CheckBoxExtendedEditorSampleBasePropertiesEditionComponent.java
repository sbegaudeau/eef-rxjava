...
public class CheckBoxExtendedEditorSampleBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(final Notification msg) {
				if (basePart == null)
					CheckBoxExtendedEditorSampleBasePropertiesEditionComponent.this.dispose();
				else {
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if ((checkBoxExtendedEditorSample != null) && (basePart != null)) { 
			cc.append(SetCommand.create(editingDomain, checkBoxExtendedEditorSample, EefnrextPackage.eINSTANCE.getCheckBoxExtendedEditorSample_CheckboxEditorSample(), basePart.getCheckboxEditorSample()));
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof CheckBoxExtendedEditorSample) {
			CheckBoxExtendedEditorSample checkBoxExtendedEditorSampleToUpdate = (CheckBoxExtendedEditorSample)source;
			checkBoxExtendedEditorSampleToUpdate.setCheckboxEditorSample(new Boolean(basePart.getCheckboxEditorSample()).booleanValue());


			return checkBoxExtendedEditorSampleToUpdate;
		}
		else
			return null;
	}
	...
	public void firePropertiesChanged(IPropertiesEditionEvent event) {
		if (!isInitializing()) {
			...
			if (EefnrextViewsRepository.CheckBoxExtendedEditorSample.checkboxEditorSample == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, checkBoxExtendedEditorSample, EefnrextPackage.eINSTANCE.getCheckBoxExtendedEditorSample_CheckboxEditorSample(), event.getNewValue()));
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			EObject copy = EcoreUtil.copy(checkBoxExtendedEditorSample);
