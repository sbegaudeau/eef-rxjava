 ...
 * </copyright>
 *
 * $Id: OwnerItemProvider.java,v 1.1 2010/11/24 21:51:10 glefur Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.eef.eefnr.navigation.Owner} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OwnerItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NavigationPackage.Literals.OWNER__MULTIPLE_REFERENCERS);
			childrenFeatures.add(NavigationPackage.Literals.OWNER__SINGLE_REFERENCERS);
		}
	...
	public String getText(Object object) {
		String label = ((Owner)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Owner_type") :
			getString("_UI_Owner_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NavigationPackage.Literals.OWNER__MULTIPLE_REFERENCERS,
				 NavigationFactory.eINSTANCE.createMultipleReferencer()));

		newChildDescriptors.add
			(createChildParameter
				(NavigationPackage.Literals.OWNER__SINGLE_REFERENCERS,
				 NavigationFactory.eINSTANCE.createSingleReferencer()));
	}
