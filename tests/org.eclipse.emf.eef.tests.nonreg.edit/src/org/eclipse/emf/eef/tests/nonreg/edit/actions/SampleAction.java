...
public class SampleAction implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		if (!selection.isEmpty()) {
			SmartModelNavigationSample firstElement = (SmartModelNavigationSample) selection.getFirstElement();
			EditingDomain editingDomain = activeEditor.getEditingDomain();
			editingDomain.getCommandStack().execute(RemoveCommand.create(editingDomain, firstElement.getSeveralFirstModelNavigation()));
