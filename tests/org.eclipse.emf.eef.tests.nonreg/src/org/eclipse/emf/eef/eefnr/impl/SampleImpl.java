 ...
 * </copyright>
 *
 * $Id: SampleImpl.java,v 1.1 2010/02/02 10:03:51 nlepine Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.eef.eefnr.impl.SampleImpl#getTextRequiredProperty <em>Text Required Property</em>}</li>
 *   <li>{@link org.eclipse.emf.eef.eefnr.impl.SampleImpl#getTextOptionalProperty <em>Text Optional Property</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SampleImpl extends AbstractSampleImpl implements Sample {
	/**
	...
	protected EClass eStaticClass() {
		return EefnrPackage.Literals.SAMPLE;
	}
	...
	public void setTextRequiredProperty(String newTextRequiredProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefnrPackage.SAMPLE__TEXT_REQUIRED_PROPERTY, oldTextRequiredProperty, textRequiredProperty));
	}
	...
	public void setTextOptionalProperty(String newTextOptionalProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefnrPackage.SAMPLE__TEXT_OPTIONAL_PROPERTY, oldTextOptionalProperty, textOptionalProperty));
	}
