 ...
 *
 * $Id: ScoreItemProvider.java,v 1.1 2010/06/18 12:13:17 glefur Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.worldcupforecast.Score} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScoreItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Score_scoreTeam1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Score_scoreTeam1_feature", "_UI_Score_type"),
				 WorldcupforecastPackage.Literals.SCORE__SCORE_TEAM1,
				 true,
				 false,
				 false,
	...
	protected void addScoreTeam2PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Score_scoreTeam2_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Score_scoreTeam2_feature", "_UI_Score_type"),
				 WorldcupforecastPackage.Literals.SCORE__SCORE_TEAM2,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Score_type") + " " + score.getScoreTeam1();
	}
