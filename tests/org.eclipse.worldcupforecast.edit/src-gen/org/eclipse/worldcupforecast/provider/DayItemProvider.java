 ...
 *
 * $Id: DayItemProvider.java,v 1.1 2010/06/18 12:13:16 glefur Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.worldcupforecast.Day} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DayItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Day_date_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Day_date_feature", "_UI_Day_type"),
				 WorldcupforecastPackage.Literals.DAY__DATE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Day)object).getDate();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Day.class)) {
			case WorldcupforecastPackage.DAY__DATE:
