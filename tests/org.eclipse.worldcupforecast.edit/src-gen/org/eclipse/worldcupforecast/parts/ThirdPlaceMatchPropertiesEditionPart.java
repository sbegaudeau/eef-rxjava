 ...
 * 
 */
public interface ThirdPlaceMatchPropertiesEditionPart {
	...
	/**
	 * @return the Team1 looser of match
	 * 
	 */
	public EObject getTeam1LooserOfMatch();

	/**
	 * Init the Team1 looser of match
	...
	/**
	 * Defines a new Team1 looser of match
	 * @param newValue the new Team1 looser of match to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the Team1 looser of match edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return the Team2 looser of match
	 * 
	 */
	public EObject getTeam2LooserOfMatch();

	/**
	 * Init the Team2 looser of match
	 * @param allResources the ResourceSet where the widget have to process
	 * @param current the current value
	 */
	...
	/**
	 * Defines a new Team2 looser of match
	 * @param newValue the new Team2 looser of match to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the Team2 looser of match edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
