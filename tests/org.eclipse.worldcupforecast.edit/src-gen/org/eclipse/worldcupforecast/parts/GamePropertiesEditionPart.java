 ...
 * 
 */
public interface GamePropertiesEditionPart {
	...
	/**
	 * Defines a new team1
	 * @param newValue the new team1 to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the team1 edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * Defines a new team2
	 * @param newValue the new team2 to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the team2 edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * Defines a new groupStage
	 * @param newValue the new groupStage to set
	 * 
	 */
	public void setGroupStage(Boolean newValue);
