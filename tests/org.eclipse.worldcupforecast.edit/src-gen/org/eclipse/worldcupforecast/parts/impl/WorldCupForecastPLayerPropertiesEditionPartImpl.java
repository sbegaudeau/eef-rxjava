 ...
 * 
 */
public class WorldCupForecastPLayerPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, WorldCupForecastPLayerPropertiesEditionPart {
	 ...
	 * 
	 */
	public WorldCupForecastPLayerPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(Composite view) { 
		createPlayerAdvancedTableComposition(view);
	 ...
	 * 
	 */
	protected void createPlayerAdvancedTableComposition(Composite parent) {
		...
		this.player.setHelpText(propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.WorldCupForecastPLayer.player, WorldcupforecastViewsRepository.SWT_KIND));
		this.player.createControls(parent);
	...
	protected void movePlayer(Player element, int oldIndex, int newIndex) {
		...
		player.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastPLayerPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.WorldCupForecastPLayer.player, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToPlayer() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						player.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastPLayerPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.WorldCupForecastPLayer.player, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromPlayer(Player element) {
		// Start of user code removeFromPlayer() method body
				EObject editedElement = playerEditUtil.foundCorrespondingEObject(element);
				playerEditUtil.removeElement(element);
				player.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastPLayerPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.WorldCupForecastPLayer.player, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));		
		// End of user code
		...
		// Start of user code editPlayer() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						player.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastPLayerPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.WorldCupForecastPLayer.player, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}		
		// End of user code
