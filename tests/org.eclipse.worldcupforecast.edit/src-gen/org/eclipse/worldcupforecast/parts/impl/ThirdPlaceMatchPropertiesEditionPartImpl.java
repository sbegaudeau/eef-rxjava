 ...
 * 
 */
public class ThirdPlaceMatchPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ThirdPlaceMatchPropertiesEditionPart {
	 ...
	 * 
	 */
	public ThirdPlaceMatchPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected void createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(WorldcupforecastMessages.ThirdPlaceMatchPropertiesEditionPart_PropertiesGroupLabel);
		...
		createTeam1LooserOfMatchFlatComboViewer(propertiesGroup);
		createTeam2LooserOfMatchFlatComboViewer(propertiesGroup);
	...
	protected void createHoursText(Composite parent) {
		SWTUtils.createPartLabel(parent, WorldcupforecastMessages.ThirdPlaceMatchPropertiesEditionPart_HoursLabel, propertiesEditionComponent.isRequired(WorldcupforecastViewsRepository.ThirdPlaceMatch.hours, WorldcupforecastViewsRepository.SWT_KIND));
		...
		hours.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ThirdPlaceMatchPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.ThirdPlaceMatch.hours, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, hours.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.ThirdPlaceMatch.hours, WorldcupforecastViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createMinutesText(Composite parent) {
		SWTUtils.createPartLabel(parent, WorldcupforecastMessages.ThirdPlaceMatchPropertiesEditionPart_MinutesLabel, propertiesEditionComponent.isRequired(WorldcupforecastViewsRepository.ThirdPlaceMatch.minutes, WorldcupforecastViewsRepository.SWT_KIND));
		...
		minutes.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ThirdPlaceMatchPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.ThirdPlaceMatch.minutes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, minutes.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.ThirdPlaceMatch.minutes, WorldcupforecastViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createCoefficientText(Composite parent) {
		SWTUtils.createPartLabel(parent, WorldcupforecastMessages.ThirdPlaceMatchPropertiesEditionPart_CoefficientLabel, propertiesEditionComponent.isRequired(WorldcupforecastViewsRepository.ThirdPlaceMatch.coefficient, WorldcupforecastViewsRepository.SWT_KIND));
		...
		coefficient.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ThirdPlaceMatchPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.ThirdPlaceMatch.coefficient, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, coefficient.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.ThirdPlaceMatch.coefficient, WorldcupforecastViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	 ...
	 * 
	 */
	protected void createTeam1LooserOfMatchFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, WorldcupforecastMessages.ThirdPlaceMatchPropertiesEditionPart_Team1LooserOfMatchLabel, propertiesEditionComponent.isRequired(WorldcupforecastViewsRepository.ThirdPlaceMatch.team1LooserOfMatch, WorldcupforecastViewsRepository.SWT_KIND));
		...
		team1LooserOfMatch.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ThirdPlaceMatchPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.ThirdPlaceMatch.team1LooserOfMatch, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getTeam1LooserOfMatch()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.ThirdPlaceMatch.team1LooserOfMatch, WorldcupforecastViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	 ...
	 * 
	 */
	protected void createTeam2LooserOfMatchFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, WorldcupforecastMessages.ThirdPlaceMatchPropertiesEditionPart_Team2LooserOfMatchLabel, propertiesEditionComponent.isRequired(WorldcupforecastViewsRepository.ThirdPlaceMatch.team2LooserOfMatch, WorldcupforecastViewsRepository.SWT_KIND));
		...
		team2LooserOfMatch.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ThirdPlaceMatchPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.ThirdPlaceMatch.team2LooserOfMatch, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getTeam2LooserOfMatch()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.ThirdPlaceMatch.team2LooserOfMatch, WorldcupforecastViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createTeam1FlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, WorldcupforecastMessages.ThirdPlaceMatchPropertiesEditionPart_Team1Label, propertiesEditionComponent.isRequired(WorldcupforecastViewsRepository.ThirdPlaceMatch.team1, WorldcupforecastViewsRepository.SWT_KIND));
		...
		team1.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ThirdPlaceMatchPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.ThirdPlaceMatch.team1, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getTeam1()));
			}

		});
		GridData team1Data = new GridData(GridData.FILL_HORIZONTAL);
		team1.setLayoutData(team1Data);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.ThirdPlaceMatch.team1, WorldcupforecastViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createTeam2FlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, WorldcupforecastMessages.ThirdPlaceMatchPropertiesEditionPart_Team2Label, propertiesEditionComponent.isRequired(WorldcupforecastViewsRepository.ThirdPlaceMatch.team2, WorldcupforecastViewsRepository.SWT_KIND));
		...
		team2.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ThirdPlaceMatchPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.ThirdPlaceMatch.team2, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getTeam2()));
			}

		});
		GridData team2Data = new GridData(GridData.FILL_HORIZONTAL);
		team2.setLayoutData(team2Data);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.ThirdPlaceMatch.team2, WorldcupforecastViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createTypeEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, WorldcupforecastMessages.ThirdPlaceMatchPropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(WorldcupforecastViewsRepository.ThirdPlaceMatch.type, WorldcupforecastViewsRepository.SWT_KIND));
		type = new EMFComboViewer(parent);
		type.setContentProvider(new ArrayContentProvider());
		type.setLabelProvider(new AdapterFactoryLabelProvider(new EcoreAdapterFactory()));
		GridData typeData = new GridData(GridData.FILL_HORIZONTAL);
		type.getCombo().setLayoutData(typeData);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.ThirdPlaceMatch.type, WorldcupforecastViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
