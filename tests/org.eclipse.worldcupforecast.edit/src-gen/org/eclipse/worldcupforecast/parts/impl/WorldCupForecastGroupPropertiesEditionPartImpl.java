 ...
 * 
 */
public class WorldCupForecastGroupPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, WorldCupForecastGroupPropertiesEditionPart {
	 ...
	 * 
	 */
	public WorldCupForecastGroupPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(Composite view) { 
		createGroupAdvancedTableComposition(view);
	...
	protected void createGroupAdvancedTableComposition(Composite parent) {
		...
		this.group.setHelpText(propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.WorldCupForecastGroup.group, WorldcupforecastViewsRepository.SWT_KIND));
	...
	protected void moveGroup(WorldCupGroup element, int oldIndex, int newIndex) {
		...
		group.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastGroupPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.WorldCupForecastGroup.group, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToGroup() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						group.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastGroupPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.WorldCupForecastGroup.group, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromGroup(WorldCupGroup element) {
		// Start of user code removeFromGroup() method body
				...
				group.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastGroupPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.WorldCupForecastGroup.group, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));		
		// End of user code
		...
		// Start of user code editGroup() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						group.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastGroupPropertiesEditionPartImpl.this, WorldcupforecastViewsRepository.WorldCupForecastGroup.group, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}		
		// End of user code
