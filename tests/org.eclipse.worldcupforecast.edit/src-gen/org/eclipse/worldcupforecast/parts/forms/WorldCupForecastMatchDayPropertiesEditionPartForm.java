 ...
 * 
 */
public class WorldCupForecastMatchDayPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, WorldCupForecastMatchDayPropertiesEditionPart {
	 ...
	 * 
	 */
	public WorldCupForecastMatchDayPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		createGameTableComposition(widgetFactory, view);
	 ...
	 * 
	 */
	protected void createGameTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.game.setHelpText(propertiesEditionComponent.getHelpContent(WorldcupforecastViewsRepository.WorldCupForecastMatchDay.game, WorldcupforecastViewsRepository.FORM_KIND));
		this.game.createControls(parent, widgetFactory);
	...
	protected void moveGame(MatchDay element, int oldIndex, int newIndex) {
		...
		game.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastMatchDayPropertiesEditionPartForm.this, WorldcupforecastViewsRepository.WorldCupForecastMatchDay.game, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToGame() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						game.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastMatchDayPropertiesEditionPartForm.this, WorldcupforecastViewsRepository.WorldCupForecastMatchDay.game, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromGame(MatchDay element) {
		// Start of user code for the removeFromGame() method body
				EObject editedElement = gameEditUtil.foundCorrespondingEObject(element);
				gameEditUtil.removeElement(element);
				game.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastMatchDayPropertiesEditionPartForm.this, WorldcupforecastViewsRepository.WorldCupForecastMatchDay.game, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editGame() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						game.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WorldCupForecastMatchDayPropertiesEditionPartForm.this, WorldcupforecastViewsRepository.WorldCupForecastMatchDay.game, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
