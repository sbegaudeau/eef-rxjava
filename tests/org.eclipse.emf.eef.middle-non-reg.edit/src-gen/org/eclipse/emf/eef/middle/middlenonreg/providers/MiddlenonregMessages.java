 ...
 * 
 */
public class MiddlenonregMessages extends NLS {
	private static final String BUNDLE_NAME = "org.eclipse.emf.eef.middle.middlenonreg.providers.middlenonregMessages"; //$NON-NLS-1$
