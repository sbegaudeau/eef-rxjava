 ...
 * </copyright>
 *
 * $Id: NamedElementItemProvider.java,v 1.1 2009/05/05 10:35:41 sbouchet Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.eef.middle.middlenonreg.NamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MiddlenonregPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NamedElement.class)) {
			case MiddlenonregPackage.NAMED_ELEMENT__NAME:
	...
	public ResourceLocator getResourceLocator() {
		return MiddlenonregEditPlugin.INSTANCE;
	}
