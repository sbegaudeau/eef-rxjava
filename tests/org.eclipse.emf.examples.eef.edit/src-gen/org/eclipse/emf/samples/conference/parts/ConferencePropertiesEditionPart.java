...
public interface ConferencePropertiesEditionPart {
	...
	/**
	 * @return the sitesTC to add
	 */
	public List getSitesTCToAdd();

	/**
	 * @return the sitesTC to remove
	 */
	public List getSitesTCToRemove();

	/**
	 * @return the sitesTC to move
	 */
	public List getSitesTCToMove();

	/**
	 * @return the sitesTC to edit
	 */
	public Map getSitesTCToEdit();

	/**
	 * @return the current sitesTC table
	 */
	...
	/**
	 * Update the sitesTC
	 * @param newValue the sitesTC to update
	 */
	public void updateSitesTC(EObject newValue);

	/**
	 * Adds the given filter to the sitesTC edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the sitesTC table
	 */
