 ...
 * 
 */
public class ConferencePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof Conference) && (ConferencePropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof Conference) && (refinement == ConferencePropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof Conference) && ((ConferencePropertiesEditionComponent.BASE_PART.equals(part) && refinement == ConferencePropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof Conference) {
			return new ConferencePropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
