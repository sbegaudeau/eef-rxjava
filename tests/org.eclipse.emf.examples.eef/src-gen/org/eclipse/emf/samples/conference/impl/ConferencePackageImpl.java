 ...
 * </copyright>
 *
 * $Id: ConferencePackageImpl.java,v 1.1 2009/09/04 09:07:40 glefur Exp $
 */
...
public class ConferencePackageImpl extends EPackageImpl implements ConferencePackage {
	...
	public static ConferencePackage init() {
		...
		ConferencePackageImpl theConferencePackage = (ConferencePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ConferencePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ConferencePackageImpl());
