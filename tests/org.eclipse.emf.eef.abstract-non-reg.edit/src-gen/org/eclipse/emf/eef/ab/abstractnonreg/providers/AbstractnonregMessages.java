 ...
 * 
 */
public class AbstractnonregMessages extends NLS {
	private static final String BUNDLE_NAME = "org.eclipse.emf.eef.ab.abstractnonreg.providers.abstractnonregMessages"; //$NON-NLS-1$

	public static String DocumentedElementPropertiesEditionPart_DocumentationGroupLabel;
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, AbstractnonregMessages.class);
	}

	private AbstractnonregMessages() {
