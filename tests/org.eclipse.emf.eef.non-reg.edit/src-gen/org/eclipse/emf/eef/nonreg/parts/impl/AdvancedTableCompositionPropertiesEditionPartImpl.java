 ...
 * 
 */
public class AdvancedTableCompositionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, AdvancedTableCompositionPropertiesEditionPart {
	 ...
	 */
	public AdvancedTableCompositionPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	 ...
	 * @param container
	 */
	protected void createAdvancedtablecompositionAdvancedTableComposition(Composite parent) {
		...
		this.advancedtablecomposition.setHelpText(propertiesEditionComponent.getHelpContent(NonregViewsRepository.AdvancedTableComposition.advancedtablecomposition, NonregViewsRepository.SWT_KIND));
		this.advancedtablecomposition.createControls(parent);
	...
	private void moveAdvancedtablecomposition(Site element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdvancedTableCompositionPropertiesEditionPartImpl.this, NonregViewsRepository.AdvancedTableComposition.advancedtablecomposition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
	...
	protected void addToAdvancedtablecomposition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				advancedtablecomposition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdvancedTableCompositionPropertiesEditionPartImpl.this, NonregViewsRepository.AdvancedTableComposition.advancedtablecomposition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	private void editAdvancedtablecomposition(Site element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				advancedtablecomposition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdvancedTableCompositionPropertiesEditionPartImpl.this, NonregViewsRepository.AdvancedTableComposition.advancedtablecomposition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		// End of user code
	 ...
	 * @param container
	 */
	protected void createAdvancedtablecompositionROAdvancedTableComposition(Composite parent) {
		...
		this.advancedtablecompositionRO.setHelpText(propertiesEditionComponent.getHelpContent(NonregViewsRepository.AdvancedTableComposition.advancedtablecompositionRO, NonregViewsRepository.SWT_KIND));
		this.advancedtablecompositionRO.createControls(parent);
	...
	private void moveAdvancedtablecompositionRO(Site element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdvancedTableCompositionPropertiesEditionPartImpl.this, NonregViewsRepository.AdvancedTableComposition.advancedtablecompositionRO, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
	...
	protected void addToAdvancedtablecompositionRO() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				advancedtablecompositionRO.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdvancedTableCompositionPropertiesEditionPartImpl.this, NonregViewsRepository.AdvancedTableComposition.advancedtablecompositionRO, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	private void editAdvancedtablecompositionRO(Site element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				advancedtablecompositionRO.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdvancedTableCompositionPropertiesEditionPartImpl.this, NonregViewsRepository.AdvancedTableComposition.advancedtablecompositionRO, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		// End of user code
	...
	public void setMessageForAdvancedtablecomposition(String msg, int msgLevel) {

	}

	public void unsetMessageForAdvancedtablecomposition() {
	...
	public void setMessageForAdvancedtablecompositionRO(String msg, int msgLevel) {

	}

	public void unsetMessageForAdvancedtablecompositionRO() {
