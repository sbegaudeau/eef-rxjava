...
public class TestFilterPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TestFilterPropertiesEditionPart {
	...
	private AdvancedEObjectFlatComboViewer testAEOFCV;
	 ...
	 * 
	 */
	private void moveTestART(DocumentedElement element, int oldIndex, int newIndex) {
	 ...
	 * 
	 */
	private void removeFromTestART(DocumentedElement element) {
	 ...
	 * 
	 */
	private void editTestART(DocumentedElement element) {
