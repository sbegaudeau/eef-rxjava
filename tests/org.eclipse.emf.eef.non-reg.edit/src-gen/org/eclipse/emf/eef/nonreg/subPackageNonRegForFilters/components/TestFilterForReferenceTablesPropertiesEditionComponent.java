 ...
 * 
 */
public class TestFilterForReferenceTablesPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public TestFilterForReferenceTablesPropertiesEditionComponent(EObject forFilters, String editing_mode) {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (testFilterPart == null)
					TestFilterForReferenceTablesPropertiesEditionComponent.this.dispose();
				else {
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (testFilterPart != null && key == NonregViewsRepository.TestFilter.class) {
			...
			testFilterPart.addFilterToTestART(new ViewerFilter() {
				 ...
				 */
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					Object result = EEFUtils.choiceOfValues(TestFilterForReferenceTablesPropertiesEditionComponent.this.forFilters, NonregPackage.eINSTANCE.getPerson_Assists(), (ResourceSet)parentElement);
