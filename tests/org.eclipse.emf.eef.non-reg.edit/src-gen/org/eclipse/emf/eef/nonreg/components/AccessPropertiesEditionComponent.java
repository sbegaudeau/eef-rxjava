...
public class AccessPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (access != null) {
			cc.append(SetCommand.create(editingDomain, access, NonregPackage.eINSTANCE.getAccess_Period(), new Double(basePart.getPeriod())));
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof Access) {
			...
			accessToUpdate.setPeriod(new Double(basePart.getPeriod()).doubleValue());
	...
	public void firePropertiesChanged(PropertiesEditionEvent event) {
		...
		if (PropertiesEditionEvent.COMMIT == event.getState() && IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode)) {
			...
			if (NonregViewsRepository.Access.period == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, access, NonregPackage.eINSTANCE.getAccess_Period(), new Double((String)event.getNewValue())));
			...
			if (diag != null && diag.getSeverity() != Diagnostic.OK) {
				if (NonregViewsRepository.Access.period == event.getAffectedEditor())
					basePart.setMessageForPeriod(diag.getMessage(), IMessageProvider.ERROR);


			} else {
				if (NonregViewsRepository.Access.period == event.getAffectedEditor())
					basePart.unsetMessageForPeriod();
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			validate = Diagnostician.INSTANCE.validate(access);
