...
public class CibleSuperCiblePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * The SuperCible part
	 */
	protected SuperCiblePropertiesEditionPart superCiblePart;
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if ((concreteCible != null) && (superCiblePart != null)) { 
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			EObject copy = EcoreUtil.copy(concreteCible);
			copy = getPropertiesEditionObject(copy);
			validate =  EEFRuntimePlugin.getEEFValidator().validate(copy);
		}
		else if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode))
			validate = EEFRuntimePlugin.getEEFValidator().validate(concreteCible);
	...
	public String getTabText(String p_key) {
		return superCiblePart.getTitle();
	}
}
