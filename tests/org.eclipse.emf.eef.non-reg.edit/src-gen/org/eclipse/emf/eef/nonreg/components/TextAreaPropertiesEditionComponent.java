...
public class TextAreaPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * The Base part
	 */
	private TextAreaPropertiesEditionPart basePart;
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == NonregViewsRepository.TextArea.class) {
			...
			if (person.getLastname() != null)
				basePart.setTextareaRO(person.getLastname());
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (person != null) {
			cc.append(SetCommand.create(editingDomain, person, NonregPackage.eINSTANCE.getPerson_Lastname(), basePart.getTextarea()));

			cc.append(SetCommand.create(editingDomain, person, NonregPackage.eINSTANCE.getPerson_Lastname(), basePart.getTextareaRO()));
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof Person) {
			...
			personToUpdate.setLastname(basePart.getTextarea());

			personToUpdate.setLastname(basePart.getTextareaRO());
	...
	public void firePropertiesChanged(PropertiesEditionEvent event) {
		...
		if (PropertiesEditionEvent.COMMIT == event.getState() && IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode)) {
			...
			if (diag != null && diag.getSeverity() != Diagnostic.OK) {
				if (NonregViewsRepository.TextArea.textarea == event.getAffectedEditor())
					basePart.setMessageForTextarea(diag.getMessage(), IMessageProvider.ERROR);
				if (NonregViewsRepository.TextArea.textareaRO == event.getAffectedEditor())
					basePart.setMessageForTextareaRO(diag.getMessage(), IMessageProvider.ERROR);


			} else {
				if (NonregViewsRepository.TextArea.textarea == event.getAffectedEditor())
					basePart.unsetMessageForTextarea();
				if (NonregViewsRepository.TextArea.textareaRO == event.getAffectedEditor())
					basePart.unsetMessageForTextareaRO();
