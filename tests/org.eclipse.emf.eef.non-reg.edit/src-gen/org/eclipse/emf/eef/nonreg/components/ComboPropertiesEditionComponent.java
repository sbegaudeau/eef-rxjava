 ...
 * 
 */
public class ComboPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * The Base part
	 */
	protected ComboPropertiesEditionPart basePart;
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(final Notification msg) {
				if (basePart == null)
					ComboPropertiesEditionComponent.this.dispose();
				else {
	...
	protected void runUpdateRunnable(final Notification msg) {
		if (NonregPackage.eINSTANCE.getTalk_Presenter().equals(msg.getFeature()) && basePart != null)
			basePart.setCombo((Object)msg.getNewValue());
		if (NonregPackage.eINSTANCE.getTalk_Presenter().equals(msg.getFeature()) && basePart != null)
			basePart.setComboRO((Object)msg.getNewValue());
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return NonregViewsRepository.Combo.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (talk != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ComboPropertiesEditionPart)provider.getPropertiesEditionPart(NonregViewsRepository.Combo.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == NonregViewsRepository.Combo.class)
			this.basePart = (ComboPropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (basePart != null && key == NonregViewsRepository.Combo.class) {
			...
			// init filters
			basePart.addFilterToCombo(new ViewerFilter() {
			...
			// End of user code
			basePart.addFilterToComboRO(new ViewerFilter() {
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if ((talk != null) && (basePart != null)) { 
			cc.append(SetCommand.create(editingDomain, talk, NonregPackage.eINSTANCE.getTalk_Presenter(), basePart.getCombo()));
			cc.append(SetCommand.create(editingDomain, talk, NonregPackage.eINSTANCE.getTalk_Presenter(), basePart.getComboRO()));
	...
	public boolean isRequired(String key, int kind) {
		return key == NonregViewsRepository.Combo.combo || key == NonregViewsRepository.Combo.comboRO;
	}
