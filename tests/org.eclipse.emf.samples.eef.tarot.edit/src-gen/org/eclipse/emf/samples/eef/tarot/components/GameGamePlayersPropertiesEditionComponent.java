...
public class GameGamePlayersPropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(final Notification msg) {
				if (gamePlayersPart == null)
					GameGamePlayersPropertiesEditionComponent.this.dispose();
				else {
	...
	public java.lang.Class translatePart(String key) {
		if (GAMEPLAYERS_PART.equals(key))
			return TarotViewsRepository.GamePlayers.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (game != null && GAMEPLAYERS_PART.equals(key)) {
			if (gamePlayersPart == null) {
				...
				if (provider != null) {
					gamePlayersPart = (GamePlayersPropertiesEditionPart)provider.getPropertiesEditionPart(TarotViewsRepository.GamePlayers.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == TarotViewsRepository.GamePlayers.class)
			this.gamePlayersPart = (GamePlayersPropertiesEditionPart) propertiesEditionPart;
	}
