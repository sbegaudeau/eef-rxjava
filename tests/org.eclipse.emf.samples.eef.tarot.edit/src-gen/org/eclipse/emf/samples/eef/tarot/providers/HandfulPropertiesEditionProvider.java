...
public class HandfulPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof Handful) && (HandfulPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof Handful) && (refinement == HandfulPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof Handful) && ((HandfulPropertiesEditionComponent.BASE_PART.equals(part) && refinement == HandfulPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part, java.lang.Class refinement) {
		if (eObject instanceof Handful) {
			if (HandfulPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == HandfulPropertiesEditionComponent.class)
				return new HandfulPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
