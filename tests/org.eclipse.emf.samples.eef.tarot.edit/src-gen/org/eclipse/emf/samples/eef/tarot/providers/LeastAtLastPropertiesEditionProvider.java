...
public class LeastAtLastPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof LeastAtLast) && (LeastAtLastPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof LeastAtLast) && (refinement == LeastAtLastPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof LeastAtLast) && ((LeastAtLastPropertiesEditionComponent.BASE_PART.equals(part) && refinement == LeastAtLastPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part, java.lang.Class refinement) {
		if (eObject instanceof LeastAtLast) {
			if (LeastAtLastPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == LeastAtLastPropertiesEditionComponent.class)
				return new LeastAtLastPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
