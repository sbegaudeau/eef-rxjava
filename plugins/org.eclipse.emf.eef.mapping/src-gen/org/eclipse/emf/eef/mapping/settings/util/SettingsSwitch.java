 ...
 * $Id$
 */
package org.eclipse.emf.eef.mapping.settings.util;
...
public class SettingsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case SettingsPackage.EDITOR_SETTINGS: {
		...
		case SettingsPackage.EREFERENCE_VIEWER_SETTINGS: {
			EReferenceViewerSettings eReferenceViewerSettings = (EReferenceViewerSettings) theEObject;
			T result = caseEReferenceViewerSettings(eReferenceViewerSettings);
			if (result == null)
				result = caseEditorSettings(eReferenceViewerSettings);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EReference Viewer Settings</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EReference Viewer Settings</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEReferenceViewerSettings(EReferenceViewerSettings object) {
		return null;
	}
