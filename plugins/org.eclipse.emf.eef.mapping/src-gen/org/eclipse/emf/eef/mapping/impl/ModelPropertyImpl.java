 ...
 * @generated
 */
public abstract class ModelPropertyImpl extends DocumentedElementImpl implements ModelProperty {
	/**
		...
		if (binding != null && binding.eIsProxy()) {
			...
			if (binding != oldBinding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MappingPackage.MODEL_PROPERTY__BINDING, oldBinding, binding));
			}
		}
		return binding;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBinding(StandardPropertyBinding newBinding, NotificationChain msgs) {
		StandardPropertyBinding oldBinding = binding;
		binding = newBinding;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MappingPackage.MODEL_PROPERTY__BINDING, oldBinding, newBinding);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setBinding(StandardPropertyBinding newBinding) {
		if (newBinding != binding) {
			...
			if (binding != null)
				msgs = ((InternalEObject) binding).eInverseRemove(this, MappingPackage.STANDARD_PROPERTY_BINDING__MODEL, StandardPropertyBinding.class, msgs);
			if (newBinding != null)
				msgs = ((InternalEObject) newBinding).eInverseAdd(this, MappingPackage.STANDARD_PROPERTY_BINDING__MODEL, StandardPropertyBinding.class, msgs);
			msgs = basicSetBinding(newBinding, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.MODEL_PROPERTY__BINDING, newBinding, newBinding));
	}
	...
	public NotificationChain basicSetModelElement(ModelElement newModelElement, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newModelElement, MappingPackage.MODEL_PROPERTY__MODEL_ELEMENT, msgs);
		return msgs;
	}
	...
	public void setModelElement(ModelElement newModelElement) {
		if (newModelElement != eInternalContainer() || (eContainerFeatureID() != MappingPackage.MODEL_PROPERTY__MODEL_ELEMENT && newModelElement != null)) {
			...
			if (newModelElement != null)
				msgs = ((InternalEObject) newModelElement).eInverseAdd(this, MappingPackage.MODEL_ELEMENT__PROPERTIES, ModelElement.class, msgs);
			msgs = basicSetModelElement(newModelElement, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.MODEL_PROPERTY__MODEL_ELEMENT, newModelElement, newModelElement));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case MappingPackage.MODEL_PROPERTY__MODEL_ELEMENT:
			return eInternalContainer().eInverseRemove(this, MappingPackage.MODEL_ELEMENT__PROPERTIES, ModelElement.class, msgs);
		}
