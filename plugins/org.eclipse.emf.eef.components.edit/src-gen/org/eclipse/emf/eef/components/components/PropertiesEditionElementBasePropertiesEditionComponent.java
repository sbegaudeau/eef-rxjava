 ...
 * 
 *
 * $Id: PropertiesEditionElementBasePropertiesEditionComponent.java,v 1.11 2009/12/10 15:51:26 sbouchet Exp $
 */
...
public class PropertiesEditionElementBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			validate = Diagnostician.INSTANCE.validate(propertiesEditionElement);
