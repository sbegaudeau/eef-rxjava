...
public class PropertiesEditionElementPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof PropertiesEditionElement) 
					&& (ComponentsPackage.Literals.PROPERTIES_EDITION_ELEMENT == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			return toTest instanceof EObject && ComponentsPackage.Literals.PROPERTIES_EDITION_ELEMENT == ((EObject)toTest).eClass();
		}
