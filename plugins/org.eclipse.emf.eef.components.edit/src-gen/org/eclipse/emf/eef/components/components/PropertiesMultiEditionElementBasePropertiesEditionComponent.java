 ...
 * 
 *
 * $Id: PropertiesMultiEditionElementBasePropertiesEditionComponent.java,v 1.10 2009/12/04 15:49:07 sbouchet Exp $
 */
...
public class PropertiesMultiEditionElementBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			validate = Diagnostician.INSTANCE.validate(propertiesMultiEditionElement);
