 ...
 * 
 *
 * $Id: PropertiesEditionContextPropertiesEditionComponent.java,v 1.9 2009/12/04 15:49:07 sbouchet Exp $
 */
...
public class PropertiesEditionContextPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public PropertiesEditionContextPropertiesEditionComponent(EObject propertiesEditionContext, String editing_mode) {
		...
		if (propertiesEditionContext instanceof PropertiesEditionContext) {
			propertiesEditionContextBasePropertiesEditionComponent = new PropertiesEditionContextBasePropertiesEditionComponent(propertiesEditionContext, editing_mode); 
			addSubComponent(propertiesEditionContextBasePropertiesEditionComponent);
			documentedElementPropertiesEditionComponent = new DocumentedElementPropertiesEditionComponent(propertiesEditionContext, editing_mode);
