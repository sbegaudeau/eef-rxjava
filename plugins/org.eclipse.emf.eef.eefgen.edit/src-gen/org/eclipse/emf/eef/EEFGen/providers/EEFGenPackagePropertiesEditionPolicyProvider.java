 ...
 * 
 */
public class EEFGenPackagePropertiesEditionPolicyProvider extends StandardPropertiesEditingPolicyProvider {
	...
	public boolean provides(IPropertiesEditionContext context) {
		if (context instanceof EObjectPropertiesEditionContext) {
			...
			return eObject != null && (EEFGenPackage.eINSTANCE.equals(eObject.eClass().getEPackage()) || EEFGenPackage.eINSTANCE.getESubpackages().contains(eObject.eClass().getEPackage()));
		}
		return false;
	}
