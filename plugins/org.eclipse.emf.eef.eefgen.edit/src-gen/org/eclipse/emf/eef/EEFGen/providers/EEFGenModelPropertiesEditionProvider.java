...
public class EEFGenModelPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof EEFGenModel) && (EEFGenModelPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof EEFGenModel) && (refinement == EEFGenModelPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof EEFGenModel) && ((EEFGenModelPropertiesEditionComponent.BASE_PART.equals(part) && refinement == EEFGenModelPropertiesEditionComponent.class));
	}
