...
public class EEFGenModelPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof EEFGenModel) && (EEFGenModelPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EEFGenPackage.Literals.EEF_GEN_MODEL == eObj.eClass();
		}
