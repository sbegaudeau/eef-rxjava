 ...
 * 
 *
 * $Id: DocumentedElementPropertiesEditionComponent.java,v 1.1 2009/04/30 17:16:51 glefur Exp $
 */
	...
	public void firePropertiesChanged(PathedPropertiesEditionEvent event) {
		...
		if (PathedPropertiesEditionEvent.COMMIT == event.getState() && IPropertiesEditionComponent.LIVE_MODE.equals(mode)) {
			...
			if (ViewsViewsRepository.Documentation.documentation == event.getAffectedEditor())
				command = SetCommand.create(liveEditingDomain, documentedElement, ViewsPackage.eINSTANCE.getDocumentedElement_Documentation(), event.getNewValue());
