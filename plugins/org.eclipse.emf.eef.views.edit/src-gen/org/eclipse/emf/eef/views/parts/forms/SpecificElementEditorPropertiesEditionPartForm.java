 ...
 * 
 *
 * $Id: SpecificElementEditorPropertiesEditionPartForm.java,v 1.1 2009/04/30 17:16:52 glefur Exp $
 */
...
public class SpecificElementEditorPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, SpecificElementEditorPropertiesEditionPart {
	...
	private void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ViewsMessages.SpecificElementEditorPropertiesEditionPart_NameLabel, true);
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(SpecificElementEditorPropertiesEditionPartForm.this, ViewsViewsRepository.SpecificElementEditor.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(SpecificElementEditorPropertiesEditionPartForm.this, ViewsViewsRepository.SpecificElementEditor.name, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createRepresentationFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createPartLabel(widgetFactory, parent, ViewsMessages.SpecificElementEditorPropertiesEditionPart_RepresentationLabel, false);
		...
		representation.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(SpecificElementEditorPropertiesEditionPartForm.this, ViewsViewsRepository.SpecificElementEditor.representation, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, getRepresentation()));
			}
		...
		readOnly = widgetFactory.createButton(parent, ViewsMessages.SpecificElementEditorPropertiesEditionPart_ReadOnlyLabel, SWT.CHECK);
   		readOnly.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(SpecificElementEditorPropertiesEditionPartForm.this, ViewsViewsRepository.SpecificElementEditor.readOnly, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(readOnly.getSelection())));
			}
