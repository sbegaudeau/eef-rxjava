 ...
 * 
 *
 * $Id: DocumentedElementPropertiesEditionProvider.java,v 1.1 2009/04/30 17:16:51 glefur Exp $
 */
...
public class DocumentedElementPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(EObject eObject,
		...
		if (eObject instanceof DocumentedElement) {
			if (DocumentedElementPropertiesEditionComponent.SWT_KIND.equals(kind)) {
				if (DocumentedElementPropertiesEditionComponent.DOCUMENTATION_PART.equals(part))
					return new DocumentationPropertiesEditionPartImpl(editionComponent);
			}
		}
		if (DocumentedElementPropertiesEditionComponent.FORM_KIND.equals(kind)) {
				if (DocumentedElementPropertiesEditionComponent.DOCUMENTATION_PART.equals(part))
