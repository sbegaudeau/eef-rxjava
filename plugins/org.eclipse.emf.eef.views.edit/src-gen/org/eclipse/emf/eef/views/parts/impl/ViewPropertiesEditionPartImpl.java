 ...
 * 
 *
 * $Id: ViewPropertiesEditionPartImpl.java,v 1.1 2009/04/30 17:16:52 glefur Exp $
 */
...
public class ViewPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ViewPropertiesEditionPart {
	...
	private void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, ViewsMessages.ViewPropertiesEditionPart_NameLabel, true);
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ViewPropertiesEditionPartImpl.this, ViewsViewsRepository.View.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createRepresentationFlatComboViewer(Composite parent) {
		...
		SWTUtils.createPartLabel(parent, ViewsMessages.ViewPropertiesEditionPart_RepresentationLabel, false);		
		...
		representation.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ViewPropertiesEditionPartImpl.this, ViewsViewsRepository.View.representation, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, getRepresentation()));
			}
