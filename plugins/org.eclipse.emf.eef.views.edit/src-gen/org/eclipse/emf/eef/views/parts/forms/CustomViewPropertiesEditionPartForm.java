 ...
 * 
 *
 * $Id: CustomViewPropertiesEditionPartForm.java,v 1.1 2009/04/30 17:16:52 glefur Exp $
 */
...
public class CustomViewPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, CustomViewPropertiesEditionPart {
	...
	private void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ViewsMessages.CustomViewPropertiesEditionPart_NameLabel, true);
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(CustomViewPropertiesEditionPartForm.this, ViewsViewsRepository.CustomView.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(CustomViewPropertiesEditionPartForm.this, ViewsViewsRepository.CustomView.name, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
