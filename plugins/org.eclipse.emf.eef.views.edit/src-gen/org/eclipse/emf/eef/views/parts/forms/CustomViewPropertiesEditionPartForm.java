...
public class CustomViewPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CustomViewPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, ViewsViewsRepository.CustomView.Properties.name, ViewsMessages.CustomViewPropertiesEditionPart_NameLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CustomViewPropertiesEditionPartForm.this,
							ViewsViewsRepository.CustomView.Properties.name,
