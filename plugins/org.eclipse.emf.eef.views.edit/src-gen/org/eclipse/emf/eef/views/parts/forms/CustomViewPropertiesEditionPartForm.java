 ...
 * 
 *
 * $Id: CustomViewPropertiesEditionPartForm.java,v 1.3 2009/05/05 12:07:55 sbouchet Exp $
 */
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CustomViewPropertiesEditionPartForm.this, ViewsViewsRepository.CustomView.name, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CustomViewPropertiesEditionPartForm.this, ViewsViewsRepository.CustomView.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ViewsViewsRepository.CustomView.name, ViewsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
