...
public class WidgetPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof Widget) && (WidgetPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof Widget) && (refinement == WidgetPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof Widget) && ((WidgetPropertiesEditionComponent.BASE_PART.equals(part) && refinement == WidgetPropertiesEditionComponent.class));
	}
