 ...
 * 
 *
 * $Id: ToolkitPropertiesEditionPartImpl.java,v 1.6 2009/05/20 15:52:02 sbouchet Exp $
 */
...
public class ToolkitPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ToolkitPropertiesEditionPart {
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, ToolkitsMessages.ToolkitPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ToolkitsViewsRepository.Toolkit.name, ToolkitsViewsRepository.SWT_KIND));
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ToolkitPropertiesEditionPartImpl.this, ToolkitsViewsRepository.Toolkit.name, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, name.getText()));
			}
			
		});

		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ToolkitsViewsRepository.Toolkit.name, ToolkitsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
