 ...
 * 
 *
 * $Id: WidgetPropertiesEditionComponent.java,v 1.3 2009/05/05 12:07:56 sbouchet Exp $
 */
...
public class WidgetPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == ToolkitsViewsRepository.Widget.class) {
			...
			Widget widget = (Widget)elt;
			if (widget.getName() != null)
				basePart.setName(widget.getName());
	...
	public void firePropertiesChanged(PropertiesEditionEvent event) {
		...
		if (PropertiesEditionEvent.COMMIT == event.getState() && IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode)) {
			...
			if (ToolkitsViewsRepository.Widget.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, widget, ToolkitsPackage.eINSTANCE.getWidget_Name(), event.getNewValue()));
