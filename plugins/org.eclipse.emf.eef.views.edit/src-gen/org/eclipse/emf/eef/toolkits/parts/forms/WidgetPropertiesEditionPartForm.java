 ...
 * 
 */
public class WidgetPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, WidgetPropertiesEditionPart {
	 ...
	 */
	public WidgetPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WidgetPropertiesEditionPartForm.this,
							ToolkitsViewsRepository.Widget.Properties.name,
