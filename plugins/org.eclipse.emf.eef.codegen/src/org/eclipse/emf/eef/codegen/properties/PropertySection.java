 ...
 *******************************************************************************/
package org.eclipse.emf.eef.codegen.properties;
...
public class PropertySection {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "PropertySection";
	 ...
	 * @generated
	 */
	public PropertySection(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(PropertySection.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = PropertySection.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public PropertySection(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        PropertySection generator = new PropertySection(modelURI, folder, arguments);
