 ...
 *******************************************************************************/
package org.eclipse.emf.eef.codegen.components;
...
/**
 * Entry point of the 'DynamicPropertiesEditionComponent' generation module.
 * 
 * @author <a href="mailto:goulwen.lefur@obeo.fr">Goulwen Le Fur</a>
 */
public class DynamicPropertiesEditionComponent {

	/**
	 * The name of the module.
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "DynamicPropertiesEditionComponent";
	
	/**
	 * The name of the templates that are to be generated.
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "DynamicPropertiesEditionComponent", };
	 ...
	 * @generated
	 */
	public DynamicPropertiesEditionComponent(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(DynamicPropertiesEditionComponent.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = DynamicPropertiesEditionComponent.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public DynamicPropertiesEditionComponent(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        DynamicPropertiesEditionComponent generator = new DynamicPropertiesEditionComponent(modelURI, folder, arguments);
