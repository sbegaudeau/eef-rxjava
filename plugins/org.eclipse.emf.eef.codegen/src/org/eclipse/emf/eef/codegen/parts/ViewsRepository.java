...
public class ViewsRepository {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "ViewsRepository";
	
	/**
	 * The name of the templates that are to be generated.
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "ViewsRepository", };
  ...
  /**
	 ...
	 * @generated
	 */
	public ViewsRepository(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      URL resourceURL = ViewsRepository.class.getResource(MODULE_FILE_NAME + ".emtl");
      if (resourceURL != null) {
	 ...
	 * @generated
	 */
	public ViewsRepository(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        ViewsRepository generator = new ViewsRepository(modelURI, folder, arguments);
