...
/**
 * Entry point of the 'PackagePropertiesEditionProvider' generation module.
 * 
 * @author <a href="mailto:goulwen.lefur@obeo.fr">Goulwen Le Fur</a>
 */
public class PackagePropertiesEditionProvider {

	/**
	 * The name of the module.
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "PackagePropertiesEditionProvider";
	
	/**
	 * The name of the templates that are to be generated.
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "PackagePropertiesEditionProvider", };
	 ...
	 * @generated
	 */
	public PackagePropertiesEditionProvider(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(PackagePropertiesEditionProvider.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = PackagePropertiesEditionProvider.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public PackagePropertiesEditionProvider(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        PackagePropertiesEditionProvider generator = new PackagePropertiesEditionProvider(modelURI, folder, arguments);
