...
/**
 * Entry point of the 'ContextMessagesPropertiesFR' generation module.
 * 
 * @author <a href="mailto:jonathan.musset@obeo.fr">Jonathan Musset</a>
 */
public class ContextMessagesPropertiesFR {

	/**
	 * The name of the module.
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "ContextMessagesPropertiesFR";
	
	/**
	 * The name of the templates that are to be generated.
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "ContextMessagesPropertiesFR", };
	 ...
	 * @generated
	 */
	public ContextMessagesPropertiesFR(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(ContextMessagesPropertiesFR.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = ContextMessagesPropertiesFR.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public ContextMessagesPropertiesFR(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        ContextMessagesPropertiesFR generator = new ContextMessagesPropertiesFR(modelURI, folder, arguments);
