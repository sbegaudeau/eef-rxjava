...
/**
 * Entry point of the 'ContextMessages' generation module.
 * 
...
public class ContextMessages {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "ContextMessages";
	
	/**
	 * The name of the templates that are to be generated.
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "ContextMessages", };
  ...
  /**
	 ...
	 * @generated
	 */
	public ContextMessages(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      URL resourceURL = ContextMessages.class.getResource(MODULE_FILE_NAME + ".emtl");
      if (resourceURL != null) {
	 ...
	 * @generated
	 */
	public ContextMessages(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        ContextMessages generator = new ContextMessages(modelURI, folder, arguments);
