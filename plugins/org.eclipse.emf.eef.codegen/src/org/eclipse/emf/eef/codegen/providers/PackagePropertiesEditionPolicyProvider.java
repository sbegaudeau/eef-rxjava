 ...
 */
public class PackagePropertiesEditionPolicyProvider {
	 ...
	 * @generated
	 */
	public PackagePropertiesEditionPolicyProvider(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(PackagePropertiesEditionPolicyProvider.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = PackagePropertiesEditionPolicyProvider.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public PackagePropertiesEditionPolicyProvider(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
