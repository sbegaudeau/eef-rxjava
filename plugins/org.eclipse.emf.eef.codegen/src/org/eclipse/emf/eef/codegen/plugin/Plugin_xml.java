...
public class Plugin_xml {
  ...
  /**
	 ...
	 * @generated
	 */
	public Plugin_xml(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      URL resourceURL = Plugin_xml.class.getResource(MODULE_FILE_NAME + ".emtl");
      if (resourceURL != null) {
	 ...
	 * @generated
	 */
	public Plugin_xml(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
