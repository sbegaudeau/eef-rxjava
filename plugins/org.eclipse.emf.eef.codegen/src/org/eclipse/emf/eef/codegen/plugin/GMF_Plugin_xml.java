...
public class GMF_Plugin_xml {
   ...
   * @generated
   */
  public GMF_Plugin_xml(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(GMF_Plugin_xml.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = GMF_Plugin_xml.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
   ...
   * @generated
   */
  public GMF_Plugin_xml(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
