...
/**
 * Entry point of the 'PropertiesEditionPart' generation module.
 * 
 * @author <a href="mailto:goulwen.lefur@obeo.fr">Goulwen Le Fur</a>
 */
public class PropertiesEditionPart {

  /**
   * The name of the module.
   * @generated
   */
  public static final String MODULE_FILE_NAME = "PropertiesEditionPart";
  
  /**
   * The name of the templates that are to be generated.
   * @generated
   */
  public static final String[] TEMPLATE_NAMES = { "PropertiesEditionPart", };
   ...
   * @generated
   */
  public PropertiesEditionPart(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(PropertiesEditionPart.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = PropertiesEditionPart.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
   ...
   * @generated
   */
  public PropertiesEditionPart(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
  ...
  public static void main(String[] args) {
    try {
      if (args.length < 2) {
        ...
        PropertiesEditionPart generator = new PropertiesEditionPart(modelURI, folder, arguments);
