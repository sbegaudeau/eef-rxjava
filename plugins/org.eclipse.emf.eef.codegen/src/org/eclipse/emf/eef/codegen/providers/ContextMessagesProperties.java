...
/**
 * Entry point of the 'ContextMessagesProperties' generation module.
 * 
 * @author <a href="mailto:goulwen.lefur@obeo.fr">Goulwen Le Fur</a>
 */
public class ContextMessagesProperties {

	/**
	 * The name of the module.
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "ContextMessagesProperties";
	
	/**
	 * The name of the templates that are to be generated.
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "ContextMessagesProperties", };
  ...
  /**
	 ...
	 * @generated
	 */
	public ContextMessagesProperties(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      URL resourceURL = ContextMessagesProperties.class.getResource(MODULE_FILE_NAME + ".emtl");
      if (resourceURL != null) {
	 ...
	 * @generated
	 */
	public ContextMessagesProperties(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
