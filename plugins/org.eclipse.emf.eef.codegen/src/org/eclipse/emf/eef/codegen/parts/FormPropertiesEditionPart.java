 ...
 */
public class FormPropertiesEditionPart {

  /**
   * The name of the module.
   * @generated
   */
  public static final String MODULE_FILE_NAME = "FormPropertiesEditionPart";
  
  /**
   * The name of the templates that are to be generated.
   * @generated
   */
  public static final String[] TEMPLATE_NAMES = { "FormPropertiesEdionPart", };
   ...
   * @generated
   */
  public FormPropertiesEditionPart(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(FormPropertiesEditionPart.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = FormPropertiesEditionPart.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
   ...
   * @generated
   */
  public FormPropertiesEditionPart(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
  ...
  public static void main(String[] args) {
    try {
      if (args.length < 2) {
        ...
        FormPropertiesEditionPart generator = new FormPropertiesEditionPart(modelURI, folder, arguments);
