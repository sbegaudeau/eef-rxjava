...
/**
 * Entry point of the 'SubPropertiesEditionComponent' generation module.
 * 
 * @author <a href="mailto:goulwen.lefur@obeo.fr">Goulwen Le Fur</a>
 */
public class SubPropertiesEditionComponent {

	/**
	 * The name of the module.
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "SubPropertiesEditionComponent";
	
	/**
	 * The name of the templates that are to be generated.
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "SubPropertiesEditionComponent", };
	 ...
	 * @generated
	 */
	public SubPropertiesEditionComponent(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(SubPropertiesEditionComponent.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = SubPropertiesEditionComponent.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public SubPropertiesEditionComponent(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        SubPropertiesEditionComponent generator = new SubPropertiesEditionComponent(modelURI, folder, arguments);
