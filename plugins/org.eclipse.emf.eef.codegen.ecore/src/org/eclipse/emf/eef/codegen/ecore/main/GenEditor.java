...
public class GenEditor extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/eclipse/emf/eef/codegen/ecore/main/GenEditor";
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenEditor generator = new GenEditor(modelURI, folder, arguments);
