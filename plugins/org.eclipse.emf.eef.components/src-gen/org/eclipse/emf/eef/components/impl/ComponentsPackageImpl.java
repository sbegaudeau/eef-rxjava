 ...
 * 
 *
 * $Id: ComponentsPackageImpl.java,v 1.2 2009/06/09 15:47:25 sbouchet Exp $
 */
...
public class ComponentsPackageImpl extends EPackageImpl implements
	...
	public static ComponentsPackage init() {
		...
		ComponentsPackageImpl theComponentsPackage = (ComponentsPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof ComponentsPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI)
	...
	public void initializePackageContents() {
		...
		initEClass(propertiesEditionComponentEClass,
				...
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPropertiesEditionComponent_Explicit(),
				theEcorePackage.getEBoolean(), "explicit", "true", 0, 1,
