...
public class EEFEditorContributionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EditorPackage.Literals.EEF_EDITOR_CONTRIBUTION__MODEL);
		}
	...
	public String getText(Object object) {
		String label = ((EEFEditorContribution)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EEFEditorContribution_type") :
			getString("_UI_EEFEditorContribution_type") + " " + label;
	}
