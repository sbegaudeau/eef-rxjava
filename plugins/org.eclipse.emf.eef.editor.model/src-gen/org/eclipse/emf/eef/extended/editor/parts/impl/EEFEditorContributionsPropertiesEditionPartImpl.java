...
public class EEFEditorContributionsPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EEFEditorContributionsPropertiesEditionPart {
	...
	public void createControls(Composite view) { 
		CompositionSequence eEFEditorContributionsStep = new CompositionSequence();
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EditorMessages.EEFEditorContributionsPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EditorViewsRepository.EEFEditorContributions.Naming.name, EditorViewsRepository.SWT_KIND));
