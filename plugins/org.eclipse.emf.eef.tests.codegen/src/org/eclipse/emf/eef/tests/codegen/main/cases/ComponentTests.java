...
public class ComponentTests {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "ComponentTests";
  ...
  /**
	 ...
	 * @generated
	 */
	public ComponentTests(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      URL resourceURL = ComponentTests.class.getResource(MODULE_FILE_NAME + ".emtl");
      if (resourceURL != null) {
      ...
      templateURL = ComponentTests.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public ComponentTests(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
