...
public class ComponentPropertiesTests {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "ComponentPropertiesTests";
	 ...
	 * @generated
	 */
	public ComponentPropertiesTests(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      URL resourceURL = ComponentPropertiesTests.class.getResource(MODULE_FILE_NAME + ".emtl");
      if (resourceURL != null) {
      ...
      templateURL = ComponentPropertiesTests.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public ComponentPropertiesTests(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
