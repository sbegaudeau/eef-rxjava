 ...
 * 
 *
 * $Id: ToolkitsAdapterFactory.java,v 1.12 2010/03/15 16:56:52 sbouchet Exp $
 */
...
public class ToolkitsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ToolkitsSwitch<Adapter> modelSwitch = new ToolkitsSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.eef.toolkits.Toolkit <em>Toolkit</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.eef.toolkits.Widget <em>Widget</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
