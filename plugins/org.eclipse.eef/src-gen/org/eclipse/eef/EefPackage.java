...
public interface EefPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int EEF_WIDGET_DESCRIPTION_FEATURE_COUNT = CONTEXTABLE_ELEMENT_FEATURE_COUNT + 2;
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute EEF_COLUMN_DESCRIPTION__CONTEXT_CANDIDATES_EXPRESSION = eINSTANCE.getEEFColumnDescription_ContextCandidatesExpression();
