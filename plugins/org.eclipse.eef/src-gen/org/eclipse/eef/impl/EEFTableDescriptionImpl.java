...
public class EEFTableDescriptionImpl extends EEFWidgetDescriptionImpl implements EEFTableDescription {
	...
	public void setValueExpression(String newValueExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_TABLE_DESCRIPTION__VALUE_EXPRESSION, oldValueExpression,
					valueExpression));
	}
	...
	public void setEditExpression(String newEditExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_TABLE_DESCRIPTION__EDIT_EXPRESSION, oldEditExpression,
					editExpression));
	}
	...
	public EEFTableStructureDescription getTableStructure() {
		if (tableStructure != null && tableStructure.eIsProxy()) {
			...
			if (tableStructure != oldTableStructure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EefPackage.EEF_TABLE_DESCRIPTION__TABLE_STRUCTURE, oldTableStructure,
							tableStructure));
			}
		}
	...
	public void setTableStructure(EEFTableStructureDescription newTableStructure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_TABLE_DESCRIPTION__TABLE_STRUCTURE, oldTableStructure,
					tableStructure));
	}
