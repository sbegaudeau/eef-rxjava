...
public class EEFImagePickerDescriptionImpl extends EEFWidgetDescriptionImpl implements EEFImagePickerDescription {
	...
	public void setValueExpression(String newValueExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_IMAGE_PICKER_DESCRIPTION__VALUE_EXPRESSION, oldValueExpression,
					valueExpression));
	}
	...
	public void setEditExpression(String newEditExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_IMAGE_PICKER_DESCRIPTION__EDIT_EXPRESSION, oldEditExpression,
					editExpression));
	}
	...
	public void setCandidatesExpression(String newCandidatesExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_IMAGE_PICKER_DESCRIPTION__CANDIDATES_EXPRESSION,
