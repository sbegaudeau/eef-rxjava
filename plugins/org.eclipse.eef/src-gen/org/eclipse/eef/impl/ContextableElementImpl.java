...
public abstract class ContextableElementImpl extends MinimalEObjectImpl.Container implements ContextableElement {
	...
	public EList<ContextVariable> getRequiredContextVariables() {
		if (requiredContextVariables == null) {
			requiredContextVariables = new EObjectContainmentEList.Resolving<ContextVariable>(ContextVariable.class, this,
					EefPackage.CONTEXTABLE_ELEMENT__REQUIRED_CONTEXT_VARIABLES);
		}
	...
	public EList<ContextVariable> getExcludedContextVariables() {
		if (excludedContextVariables == null) {
			excludedContextVariables = new EObjectContainmentEList.Resolving<ContextVariable>(ContextVariable.class, this,
					EefPackage.CONTEXTABLE_ELEMENT__EXCLUDED_CONTEXT_VARIABLES);
		}
