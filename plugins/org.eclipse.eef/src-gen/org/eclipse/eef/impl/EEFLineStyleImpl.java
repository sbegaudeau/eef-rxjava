...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EEF Line Style</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eef.impl.EEFLineStyleImpl#getBackgroundColorExpression <em>Background Color Expression</em>}</li>
 *   <li>{@link org.eclipse.eef.impl.EEFLineStyleImpl#getForegroundColorExpression <em>Foreground Color Expression</em>}</li>
 *   <li>{@link org.eclipse.eef.impl.EEFLineStyleImpl#getHeaderBackgroundColorExpression <em>Header Background Color Expression</em>}</li>
 *   <li>{@link org.eclipse.eef.impl.EEFLineStyleImpl#getHeaderForegroundColorExpression <em>Header Foreground Color Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EEFLineStyleImpl extends EEFStyleImpl implements EEFLineStyle {
	/**
	...
	protected EClass eStaticClass() {
		return EefPackage.Literals.EEF_LINE_STYLE;
	}
	...
	public void setBackgroundColorExpression(String newBackgroundColorExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_LINE_STYLE__BACKGROUND_COLOR_EXPRESSION,
	...
	public void setForegroundColorExpression(String newForegroundColorExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_LINE_STYLE__FOREGROUND_COLOR_EXPRESSION,
	...
	public void setHeaderBackgroundColorExpression(String newHeaderBackgroundColorExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_LINE_STYLE__HEADER_BACKGROUND_COLOR_EXPRESSION,
	...
	public void setHeaderForegroundColorExpression(String newHeaderForegroundColorExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_LINE_STYLE__HEADER_FOREGROUND_COLOR_EXPRESSION,
