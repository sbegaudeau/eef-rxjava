...
public class EEFLineDescriptionImpl extends MinimalEObjectImpl.Container implements EEFLineDescription {
	...
	public void setHeaderExpression(String newHeaderExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_LINE_DESCRIPTION__HEADER_EXPRESSION, oldHeaderExpression,
					headerExpression));
	}
	...
	public void setSemanticCandidatesExpression(String newSemanticCandidatesExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_LINE_DESCRIPTION__SEMANTIC_CANDIDATES_EXPRESSION,
	...
	public void setDomainClass(String newDomainClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_LINE_DESCRIPTION__DOMAIN_CLASS, oldDomainClass, domainClass));
	}
