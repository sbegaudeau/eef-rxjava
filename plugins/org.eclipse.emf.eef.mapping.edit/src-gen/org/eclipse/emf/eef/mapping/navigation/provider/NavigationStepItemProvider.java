...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.eef.mapping.navigation.NavigationStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NavigationStepItemProvider extends ItemProviderAdapter implements
	 ...
	 * @generated
	 */
	public NavigationStepItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(NavigationPackage.Literals.NAVIGATION_STEP__SUB_STEP);
			childrenFeatures
					.add(NavigationPackage.Literals.NAVIGATION_STEP__INITIALIZER);
			childrenFeatures
					.add(NavigationPackage.Literals.NAVIGATION_STEP__FILTERS);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				NavigationPackage.Literals.NAVIGATION_STEP__SUB_STEP,
				NavigationFactory.eINSTANCE.createDeclarativeNavigationStep()));

		newChildDescriptors.add(createChildParameter(
				NavigationPackage.Literals.NAVIGATION_STEP__INITIALIZER,
				NavigationFactory.eINSTANCE
						.createJavaDeclarationStepInitializer()));

		newChildDescriptors.add(createChildParameter(
				NavigationPackage.Literals.NAVIGATION_STEP__INITIALIZER,
				NavigationFactory.eINSTANCE.createJavaBodyStepInitializer()));

		newChildDescriptors.add(createChildParameter(
				NavigationPackage.Literals.NAVIGATION_STEP__FILTERS,
