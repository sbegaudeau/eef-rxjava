 ...
 * 
 *
 * $Id: ElementBindingReferencePropertiesEditionProvider.java,v 1.16 2009/12/23 15:59:51 nlepine Exp $
 */
...
public class ElementBindingReferencePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject, String part) {
		return provides(eObject) && (ElementBindingReferenceBasePropertiesEditionComponent.BASE_PART.equals(part)
 || 
