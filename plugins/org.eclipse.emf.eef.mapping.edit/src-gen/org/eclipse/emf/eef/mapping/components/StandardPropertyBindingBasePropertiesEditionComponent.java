...
public class StandardPropertyBindingBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		if (!isInitializing()) {
			...
			if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {			
				...
				if (MappingViewsRepository.StandardPropertyBinding.model == event.getAffectedEditor()) {
					updateModel((ModelProperty)event.getNewValue());
				}
			}
	...
	private void updateName(java.lang.String newValue) {
		standardPropertyBinding.setName(newValue);	
	}
	...
	private void updateModel(ModelProperty newValue) {
		standardPropertyBinding.setModel(newValue);	
	}
