 ...
 * 
 *
 * $Id: DatabindingPropertiesEditionProvider.java,v 1.1 2009/04/30 17:14:43 glefur Exp $
 */
...
public class DatabindingPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof Databinding) {
			return new DatabindingPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionPart getPropertiesEditionPart(EObject eObject,
		...
		if (eObject instanceof Databinding) {
			if (DatabindingPropertiesEditionComponent.SWT_KIND.equals(kind)) {
				if (DocumentedElementPropertiesEditionComponent.DOCUMENTATION_PART.equals(part))
					return new DocumentationPropertiesEditionPartImpl(editionComponent);
			}
		}
		if (DatabindingPropertiesEditionComponent.FORM_KIND.equals(kind)) {
				if (DocumentedElementPropertiesEditionComponent.DOCUMENTATION_PART.equals(part))
