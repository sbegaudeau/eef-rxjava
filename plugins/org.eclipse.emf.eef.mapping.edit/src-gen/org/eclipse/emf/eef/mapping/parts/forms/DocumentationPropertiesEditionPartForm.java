 ...
 * 
 *
 * $Id: DocumentationPropertiesEditionPartForm.java,v 1.1 2009/04/30 17:14:44 glefur Exp $
 */
...
public class DocumentationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, DocumentationPropertiesEditionPart {
	...
	private void createDocumentationTextarea(FormToolkit widgetFactory, Composite parent) {
		Label documentationLabel = FormUtils.createPartLabel(widgetFactory, parent, MappingMessages.DocumentationPropertiesEditionPart_DocumentationLabel, false);
		...
		documentation.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(DocumentationPropertiesEditionPartForm.this, MappingViewsRepository.Documentation.documentation, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, documentation.getText()));
			}
