...
public class DocumentationPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, DocumentationPropertiesEditionPart {
	...
	protected Composite createDocumentationTextarea(FormToolkit widgetFactory, Composite parent) {
		Label documentationLabel = createDescription(parent, MappingViewsRepository.Documentation.Documentation_.documentation__, MappingMessages.DocumentationPropertiesEditionPart_DocumentationLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							MappingViewsRepository.Documentation.Documentation_.documentation__,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, documentation.getText()));
