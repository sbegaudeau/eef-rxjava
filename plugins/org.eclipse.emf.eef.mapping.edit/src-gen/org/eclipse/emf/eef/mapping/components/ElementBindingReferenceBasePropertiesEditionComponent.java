 ...
 * 
 *
 * $Id: ElementBindingReferenceBasePropertiesEditionComponent.java,v 1.16 2009/12/30 16:41:03 nlepine Exp $
 */
...
public class ElementBindingReferenceBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if ((elementBindingReference != null) && (basePart != null)) { 
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			EObject copy = EcoreUtil.copy(elementBindingReference);
			copy = getPropertiesEditionObject(copy);
			validate =  EEFRuntimePlugin.getEEFValidator().validate(copy);
		}
		else if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode))
			validate = EEFRuntimePlugin.getEEFValidator().validate(elementBindingReference);
