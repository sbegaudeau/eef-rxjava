 ...
 * 
 */
public class JavaBodyStepInitializerPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, JavaBodyStepInitializerPropertiesEditionPart {
	 ...
	 */
	public JavaBodyStepInitializerPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public JavaBodyStepInitializerPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(NavigationMessages.JavaBodyStepInitializerPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JavaBodyStepInitializerPropertiesEditionPartForm.this,
							NavigationViewsRepository.JavaBodyStepInitializer.Properties.body,
