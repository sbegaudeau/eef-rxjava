...
public class StrictTypingFilterPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, StrictTypingFilterPropertiesEditionPart {
	...
	protected Composite createTypeGroup(Composite parent) {
		...
		typeGroup.setText(FiltersMessages.StrictTypingFilterPropertiesEditionPart_TypeGroupLabel);
	...
	protected Composite createRestrictionFlatComboViewer(Composite parent) {
		...
		restriction = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(FiltersViewsRepository.StrictTypingFilter.Type.restriction, FiltersViewsRepository.SWT_KIND));
		...
		restriction.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StrictTypingFilterPropertiesEditionPartImpl.this, FiltersViewsRepository.StrictTypingFilter.Type.restriction, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getRestriction()));
			}
