...
public class StandardElementBindingPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof StandardElementBinding) && (StandardElementBindingBasePropertiesEditionComponent.BASE_PART.equals(part) || DocumentedElementPropertiesEditionComponent.DOCUMENTATION_PART.equals(part));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof StandardElementBinding) {
			return new StandardElementBindingPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof StandardElementBinding) {
			if (StandardElementBindingBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new StandardElementBindingBasePropertiesEditionComponent(eObject, editing_mode);
