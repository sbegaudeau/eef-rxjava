...
public class EMFMultiPropertiesBindingPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EMFMultiPropertiesBindingPropertiesEditionPart {
	 ...
	 */
	public EMFMultiPropertiesBindingPropertiesEditionPartForm() { super(); }
	...
	protected Composite createModelReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.model = new ReferencesTable(getDescription(MappingViewsRepository.EMFMultiPropertiesBinding.Binding.model, MappingMessages.EMFMultiPropertiesBindingPropertiesEditionPart_ModelLabel), new ReferencesTableListener	() {
	...
	protected Composite createViewsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.views = new ReferencesTable(getDescription(MappingViewsRepository.EMFMultiPropertiesBinding.Binding.views, MappingMessages.EMFMultiPropertiesBindingPropertiesEditionPart_ViewsLabel), new ReferencesTableListener	() {
