 ...
 * 
 *
 * $Id: EMFElementBindingPropertiesEditionPartForm.java,v 1.1 2009/04/30 17:14:44 glefur Exp $
 */
...
public class EMFElementBindingPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EMFElementBindingPropertiesEditionPart {
	...
	protected EMFElementBinding current;
	...
	private void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, MappingMessages.EMFElementBindingPropertiesEditionPart_NameLabel, true);
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EMFElementBindingPropertiesEditionPartForm.this, MappingViewsRepository.EMFElementBinding.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EMFElementBindingPropertiesEditionPartForm.this, MappingViewsRepository.EMFElementBinding.name, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createModelFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createPartLabel(widgetFactory, parent, MappingMessages.EMFElementBindingPropertiesEditionPart_ModelLabel, true);
		...
		model.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EMFElementBindingPropertiesEditionPartForm.this, MappingViewsRepository.EMFElementBinding.model, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, getModel()));
			}
				...
				"View", ViewsPackage.eINSTANCE.getView()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EMFElementBindingPropertiesEditionPartForm.this, MappingViewsRepository.EMFElementBinding.views,
	...
	private void moveViews(View element, int oldIndex, int newIndex) {
		...
		views.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EMFElementBindingPropertiesEditionPartForm.this, MappingViewsRepository.EMFElementBinding.views, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void removeFromViews(View element) {
		...
		views.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EMFElementBindingPropertiesEditionPartForm.this, MappingViewsRepository.EMFElementBinding.views, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editViews(View element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				views.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EMFElementBindingPropertiesEditionPartForm.this, MappingViewsRepository.EMFElementBinding.views, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	public void initComponent(EObject eObject, ResourceSet allResources) {
		...
		current = eMFElementBinding;
		resourceSet = allResources;
		if (eMFElementBinding.getName() != null){
			name.setText(eMFElementBinding.getName());
		}	
		viewsEditUtil = new EMFListEditUtil(eMFElementBinding, MappingPackage.eINSTANCE.getAbstractElementBinding_Views());
		this.views.setInput(viewsEditUtil.getVirtualList());	
		model.setInput(allResources);
		if (eMFElementBinding.getModel() != null){
			model.setSelection(new StructuredSelection(eMFElementBinding.getModel()));
		}
