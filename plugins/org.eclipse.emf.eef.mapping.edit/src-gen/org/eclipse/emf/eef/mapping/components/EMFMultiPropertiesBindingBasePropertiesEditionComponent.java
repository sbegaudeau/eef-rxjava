 ...
 * 
 *
 * $Id: EMFMultiPropertiesBindingBasePropertiesEditionComponent.java,v 1.13 2009/12/10 16:26:17 sbouchet Exp $
 */
...
public class EMFMultiPropertiesBindingBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			validate = Diagnostician.INSTANCE.validate(eMFMultiPropertiesBinding);
