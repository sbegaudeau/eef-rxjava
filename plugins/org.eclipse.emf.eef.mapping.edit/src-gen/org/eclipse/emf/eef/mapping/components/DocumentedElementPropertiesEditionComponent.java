...
public class DocumentedElementPropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		if (!isInitializing()) {
			...
			if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {			
				if (MappingViewsRepository.Documentation.documentation == event.getAffectedEditor()) {
					updateDocumentation((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
				}
			}
	...
	private void updateDocumentation(java.lang.String newValue) {
		documentedElement.setDocumentation(newValue);	
	}
