...
public class DocumentedElementPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof DocumentedElement) 
					&& (MappingPackage.Literals.DOCUMENTED_ELEMENT == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			return toTest instanceof EObject && MappingPackage.Literals.DOCUMENTED_ELEMENT == ((EObject)toTest).eClass();
		}
