...
public class StandardElementBindingBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		if (!isInitializing()) {
			...
			if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {			
				...
				if (MappingViewsRepository.StandardElementBinding.model == event.getAffectedEditor()) {
					updateModel((ModelElement)event.getNewValue());
				}
			}
	...
	private void updateName(java.lang.String newValue) {
		standardElementBinding.setName(newValue);	
	}
	...
	private void updateModel(ModelElement newValue) {
		standardElementBinding.setModel(newValue);	
	}
	...
	public Diagnostic validate() {
		...
		validate = EEFRuntimePlugin.getEEFValidator().validate(standardElementBinding);
