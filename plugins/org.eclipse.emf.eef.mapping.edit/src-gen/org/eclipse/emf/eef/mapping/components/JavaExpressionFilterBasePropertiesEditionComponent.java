...
public class JavaExpressionFilterBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		if (!isInitializing()) {
			...
			if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {			
				if (MappingViewsRepository.JavaExpressionFilter.javaExpressionBody == event.getAffectedEditor()) {
					updateJavaExpressionBody((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
				}
			}
	...
	private void updateJavaExpressionBody(java.lang.String newValue) {
		javaExpressionFilter.setJavaBody(newValue);	
	}
	...
	public Diagnostic validate() {
		...
		validate = EEFRuntimePlugin.getEEFValidator().validate(javaExpressionFilter);
