 ...
 * 
 *
 * $Id: JavaDeclarationFilterPropertiesEditionProvider.java,v 1.5 2009/12/30 16:40:29 nlepine Exp $
 */
...
public class JavaDeclarationFilterPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject, String part) {
		return provides(eObject)&& (JavaDeclarationFilterBasePropertiesEditionComponent.BASE_PART.equals(part) || DocumentedElementPropertiesEditionComponent.DOCUMENTATION_PART.equals(part) || FilterPropertiesPropertiesEditionComponent.FILTERPROPERTIES_PART.equals(part));
	}
