...
public class StandardPropertyBindingPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof StandardPropertyBinding) && (StandardPropertyBindingBasePropertiesEditionComponent.BASE_PART.equals(part) || DocumentedElementPropertiesEditionComponent.DOCUMENTATION_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof StandardPropertyBinding) && (refinement == StandardPropertyBindingBasePropertiesEditionComponent.class || refinement == DocumentedElementPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof StandardPropertyBinding) && ((StandardPropertyBindingBasePropertiesEditionComponent.BASE_PART.equals(part) && refinement == StandardPropertyBindingBasePropertiesEditionComponent.class) || (DocumentedElementPropertiesEditionComponent.DOCUMENTATION_PART.equals(part) && refinement == DocumentedElementPropertiesEditionComponent.class));
	}
