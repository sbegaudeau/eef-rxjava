 ...
 * 
 *
 * $Id: CategoryBasePropertiesEditionComponent.java,v 1.1 2009/04/30 17:14:42 glefur Exp $
 */
	...
	public void firePropertiesChanged(PathedPropertiesEditionEvent event) {
		...
		if (PathedPropertiesEditionEvent.COMMIT == event.getState() && IPropertiesEditionComponent.LIVE_MODE.equals(mode)) {
			...
			if (MappingViewsRepository.Category.name == event.getAffectedEditor())
				command = SetCommand.create(liveEditingDomain, category, MappingPackage.eINSTANCE.getCategory_Name(), event.getNewValue());
