 ...
 * 
 *
 * $Id: CategoryBasePropertiesEditionComponent.java,v 1.13 2009/12/10 16:26:18 sbouchet Exp $
 */
...
public class CategoryBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return MappingViewsRepository.Category.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (category != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (CategoryPropertiesEditionPart)provider.getPropertiesEditionPart(MappingViewsRepository.Category.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == MappingViewsRepository.Category.class) {
