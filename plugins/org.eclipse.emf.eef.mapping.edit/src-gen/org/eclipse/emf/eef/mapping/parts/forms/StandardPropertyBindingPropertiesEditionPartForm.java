 ...
 * 
 *
 * $Id: StandardPropertyBindingPropertiesEditionPartForm.java,v 1.1 2009/04/30 17:14:44 glefur Exp $
 */
...
public class StandardPropertyBindingPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, StandardPropertyBindingPropertiesEditionPart {
	...
	protected StandardPropertyBinding current;
	...
	private void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, MappingMessages.StandardPropertyBindingPropertiesEditionPart_NameLabel, true);
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StandardPropertyBindingPropertiesEditionPartForm.this, MappingViewsRepository.StandardPropertyBinding.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StandardPropertyBindingPropertiesEditionPartForm.this, MappingViewsRepository.StandardPropertyBinding.name, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createModelFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createPartLabel(widgetFactory, parent, MappingMessages.StandardPropertyBindingPropertiesEditionPart_ModelLabel, true);
		...
		model.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StandardPropertyBindingPropertiesEditionPartForm.this, MappingViewsRepository.StandardPropertyBinding.model, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, getModel()));
			}
			
		});
		FormUtils.createHelpButton(widgetFactory, parent, "The mapped model property", null); //$NON-NLS-1$
	}
				...
				"ElementEditor", ViewsPackage.eINSTANCE.getElementEditor()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StandardPropertyBindingPropertiesEditionPartForm.this, MappingViewsRepository.StandardPropertyBinding.views,
	...
	private void moveViews(ElementEditor element, int oldIndex, int newIndex) {
		...
		views.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StandardPropertyBindingPropertiesEditionPartForm.this, MappingViewsRepository.StandardPropertyBinding.views, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void removeFromViews(ElementEditor element) {
		...
		views.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StandardPropertyBindingPropertiesEditionPartForm.this, MappingViewsRepository.StandardPropertyBinding.views, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editViews(ElementEditor element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				views.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StandardPropertyBindingPropertiesEditionPartForm.this, MappingViewsRepository.StandardPropertyBinding.views, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	public void initComponent(EObject eObject, ResourceSet allResources) {
		...
		current = standardPropertyBinding;
		resourceSet = allResources;
		if (standardPropertyBinding.getName() != null){
			name.setText(standardPropertyBinding.getName());
		}	
		viewsEditUtil = new EMFListEditUtil(standardPropertyBinding, MappingPackage.eINSTANCE.getAbstractPropertyBinding_Views());
		this.views.setInput(viewsEditUtil.getVirtualList());	
		model.setInput(allResources);
		if (standardPropertyBinding.getModel() != null){
			model.setSelection(new StructuredSelection(standardPropertyBinding.getModel()));
		}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.emf.eef.mapping.parts.StandardPropertyBindingPropertiesEditionPart#getViewsToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.emf.eef.mapping.parts.StandardPropertyBindingPropertiesEditionPart#getViewsToRemove()
	 */
