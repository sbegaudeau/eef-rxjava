 ...
 * 
 */
public class StrictTypingFilterPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, StrictTypingFilterPropertiesEditionPart {
	 ...
	 */
	public StrictTypingFilterPropertiesEditionPartForm() { super(); }
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		strictTypingFilterStep
			.addStep(FiltersViewsRepository.StrictTypingFilter.Type.class)
			.addStep(FiltersViewsRepository.StrictTypingFilter.Type.restriction);
		
		strictTypingFilterStep.addStep(FiltersViewsRepository.StrictTypingFilter.filterProperties);
		
		composer = new PartComposer(strictTypingFilterStep) {

			@Override
			public Composite addToPart(Composite parent, Object key) {
				if (key == FiltersViewsRepository.StrictTypingFilter.Type.class) {
					return createTypeGroup(widgetFactory, parent);
				}
				if (key == FiltersViewsRepository.StrictTypingFilter.Type.restriction) {
					return createRestrictionFlatComboViewer(parent, widgetFactory);
				}
				if (key == FiltersViewsRepository.StrictTypingFilter.filterProperties) {
	...
	protected Composite createTypeGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		typeSection.setText(FiltersMessages.StrictTypingFilterPropertiesEditionPart_TypeGroupLabel);
	...
	protected Composite createRestrictionFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, FiltersViewsRepository.StrictTypingFilter.Type.restriction, FiltersMessages.StrictTypingFilterPropertiesEditionPart_RestrictionLabel);
		restriction = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(FiltersViewsRepository.StrictTypingFilter.Type.restriction, FiltersViewsRepository.FORM_KIND));
		...
		restriction.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StrictTypingFilterPropertiesEditionPartForm.this, FiltersViewsRepository.StrictTypingFilter.Type.restriction, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRestriction()));
			}

		});
		restriction.setID(FiltersViewsRepository.StrictTypingFilter.Type.restriction);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(FiltersViewsRepository.StrictTypingFilter.Type.restriction, FiltersViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createFilterProperties(FormToolkit widgetFactory, Composite container) {
		...
		filterPropertiesPropertiesEditionPart = (FilterPropertiesPropertiesEditionPart)provider.getPropertiesEditionPart(FiltersViewsRepository.FilterProperties.class, FiltersViewsRepository.FORM_KIND, propertiesEditionComponent);
...
/**
	...
	public String getTitle() {
		return FiltersMessages.StrictTypingFilter_Part_Title;
	}
