...
public class SimpleModelNavigationPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof SimpleModelNavigation) && (SimpleModelNavigationPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && NavigationPackage.Literals.SIMPLE_MODEL_NAVIGATION == eObj.eClass();
		}
