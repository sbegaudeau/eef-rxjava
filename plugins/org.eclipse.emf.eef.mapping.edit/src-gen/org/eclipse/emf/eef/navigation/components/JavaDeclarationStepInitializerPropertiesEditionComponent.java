 ...
 * 
 */
public class JavaDeclarationStepInitializerPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public JavaDeclarationStepInitializerPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject javaDeclarationStepInitializer, String editing_mode) {
		super(editingContext, javaDeclarationStepInitializer, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = NavigationViewsRepository.class;
		partKey = NavigationViewsRepository.JavaDeclarationStepInitializer.class;
	}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == NavigationViewsRepository.JavaDeclarationStepInitializer.Properties.qualifiedClass) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		JavaDeclarationStepInitializer javaDeclarationStepInitializer = (JavaDeclarationStepInitializer)semanticObject;
		if (NavigationViewsRepository.JavaDeclarationStepInitializer.Properties.qualifiedClass == event.getAffectedEditor()) {
	...
	public boolean isRequired(Object key, int kind) {
		return key == NavigationViewsRepository.JavaDeclarationStepInitializer.Properties.qualifiedClass || key == NavigationViewsRepository.JavaDeclarationStepInitializer.Properties.methodFilter;
	}
