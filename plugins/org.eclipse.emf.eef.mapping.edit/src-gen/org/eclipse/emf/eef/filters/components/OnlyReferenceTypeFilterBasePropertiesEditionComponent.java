...
public class OnlyReferenceTypeFilterBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public OnlyReferenceTypeFilterBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject onlyReferenceTypeFilter, String editing_mode) {
		...
		partKey = FiltersViewsRepository.OnlyReferenceTypeFilter.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(FiltersViewsRepository.OnlyReferenceTypeFilter.ReferencedFeature.referencedFeature_)) {
				// init part
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == FiltersViewsRepository.OnlyReferenceTypeFilter.ReferencedFeature.referencedFeature_) {
