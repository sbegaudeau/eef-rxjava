...
public class StrictTypingFilterFilterStrictTypingFilterPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public StrictTypingFilterFilterStrictTypingFilterPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject strictTypingFilter, String editing_mode) {
		...
		partKey = FiltersViewsRepository.StrictTypingFilter.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(FiltersViewsRepository.StrictTypingFilter.Type.restriction)) {
				// init part
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == FiltersViewsRepository.StrictTypingFilter.Type.restriction) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (FiltersViewsRepository.StrictTypingFilter.Type.restriction == event.getAffectedEditor()) {
	...
	public boolean isRequired(Object key, int kind) {
		return key == FiltersViewsRepository.StrictTypingFilter.Type.restriction;
	}
