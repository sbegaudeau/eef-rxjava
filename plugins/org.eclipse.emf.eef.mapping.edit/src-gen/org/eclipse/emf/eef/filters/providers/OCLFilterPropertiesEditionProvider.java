...
public class OCLFilterPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof OCLFilter) 
					&& (FiltersPackage.Literals.OCL_FILTER == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			return toTest instanceof EObject && FiltersPackage.Literals.OCL_FILTER == ((EObject)toTest).eClass();
		}
