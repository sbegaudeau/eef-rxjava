...
public class OnlyReferenceTypeFilterPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public void setPropertiesEditionPart(java.lang.Object key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (FiltersViewsRepository.OnlyReferenceTypeFilter.class == key) {
	...
	public void initPart(java.lang.Object key, int kind, EObject element, ResourceSet allResource) {
		if (key == FiltersViewsRepository.OnlyReferenceTypeFilter.class) {
			...
			filterPropertiesPropertiesEditionComponent.setPropertiesEditionPart(FiltersViewsRepository.FilterProperties.class, kind, basePart.getFilterPropertiesReferencedView());
