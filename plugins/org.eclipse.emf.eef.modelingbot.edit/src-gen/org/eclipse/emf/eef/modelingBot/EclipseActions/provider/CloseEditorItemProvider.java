 ...
 * </copyright>
 *
 * $Id: CloseEditorItemProvider.java,v 1.4 2011/11/16 13:49:39 sbouchet Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.eef.modelingBot.EclipseActions.CloseEditor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CloseEditorItemProvider
	 ...
	 * @generated
	 */
	public CloseEditorItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CloseEditor)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CloseEditor_type") :
			getString("_UI_CloseEditor_type") + " " + label;
	}
