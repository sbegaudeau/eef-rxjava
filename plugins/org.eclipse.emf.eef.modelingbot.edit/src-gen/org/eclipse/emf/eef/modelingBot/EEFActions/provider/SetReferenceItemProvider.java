 ...
 * </copyright>
 *
 * $Id: SetReferenceItemProvider.java,v 1.3 2011/11/16 13:49:39 sbouchet Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.eef.modelingBot.EEFActions.SetReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetReferenceItemProvider
	 ...
	 * @generated
	 */
	public SetReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SetReference)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SetReference_type") :
			getString("_UI_SetReference_type") + " " + label;
	}
