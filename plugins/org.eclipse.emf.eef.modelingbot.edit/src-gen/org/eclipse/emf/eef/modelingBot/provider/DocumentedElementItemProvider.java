 ...
 * </copyright>
 *
 * $Id: DocumentedElementItemProvider.java,v 1.1 2011/04/06 13:08:31 nlepine Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.eef.modelingBot.DocumentedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentedElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DocumentedElement_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DocumentedElement_name_feature", "_UI_DocumentedElement_type"),
				 ModelingBotPackage.Literals.DOCUMENTED_ELEMENT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelingBotPackage.Literals.DOCUMENTED_ELEMENT__DOCUMENTATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((DocumentedElement)object).getName();
