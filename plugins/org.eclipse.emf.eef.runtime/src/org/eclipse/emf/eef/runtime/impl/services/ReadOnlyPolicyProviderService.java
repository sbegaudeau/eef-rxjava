...
/**
 * Service that manage all the registered {@link IReadOnlyPolicy}.
 * 
...
public class ReadOnlyPolicyProviderService {
	 ...
	 * The extension name.
	 */
	public static final String EXTENSION_NAME = "ReadOnlyPolicyProvider"; //$NON-NLS-1$

	/**
	 * The extension's element name.
	 */
	private static final String EXTENSION_ELEMENT_NAME = "ReadOnlyPolicyProvider"; //$NON-NLS-1$
	 ...
	 */
	private List<IReadOnlyPolicy> readOnlyPolicies;

	/**
	 * Default constructor.
	 */
	private ReadOnlyPolicyProviderService() {
		readOnlyPolicies = new ArrayList<IReadOnlyPolicy>();
		configureService();
	}
	 ...
	 * Register a policy.
	 * 
	 * @param readOnlyPolicy IReadOnlyPolicy
	 */
	public void register(IReadOnlyPolicy readOnlyPolicy) {
		readOnlyPolicies.add(readOnlyPolicy);
	}
