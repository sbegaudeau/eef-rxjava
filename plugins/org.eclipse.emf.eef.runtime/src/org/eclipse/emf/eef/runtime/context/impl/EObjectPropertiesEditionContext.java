...
public class EObjectPropertiesEditionContext implements PropertiesEditingContext {
	 ...
	 * @param propertiesEditionComponent editingComponent holding the EObject editing
	 * @param eObject eObject to edit
	 * @param adapterFactory adapterFactory to use to get editing providers
	 */
	public EObjectPropertiesEditionContext(PropertiesEditingContext parentContext, IPropertiesEditionComponent propertiesEditionComponent, EObject eObject, AdapterFactory adapterFactory) {
