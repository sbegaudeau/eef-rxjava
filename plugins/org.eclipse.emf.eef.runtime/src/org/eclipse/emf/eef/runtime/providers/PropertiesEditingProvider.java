...
public interface PropertiesEditingProvider {
	 ...
	 * 
	 * @param editingContext the {@link PropertiesEditingContext} to provide
	...
	/**
	 * Indicates whether this provider provides the specified {@link PropertiesEditingContext} for the given part.
	 * 
	 * @param editingContext the {@link PropertiesEditingContext} to provide
	 * @param part the key of the PropertiesEditingPart to provide
	 * @return <code>true</code> if this provider provides for the specified parameters; <code>false</code> otherwise.
	 */
	public abstract boolean provides(PropertiesEditingContext editingContext, String part);

	/**
	 * Indicates whether this provider provides the specified {@link PropertiesEditingContext} for the expected type.
	 * 
	 * @param editingContext the {@link PropertiesEditingContext} to provide
	...
	/**
	 * Indicates whether this provider provides the specified {@link PropertiesEditingContext} for the given part (with the expected type).
	 * 
	 * @param editingContext the {@link PropertiesEditingContext} to provide
	 * @param part the key of the PropertiesEditingPart to provide
