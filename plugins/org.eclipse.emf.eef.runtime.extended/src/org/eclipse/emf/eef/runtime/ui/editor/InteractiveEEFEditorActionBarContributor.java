...
/**
 */
public class InteractiveEEFEditorActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	...
	protected IAction showPropertiesViewAction = new Action(
			EEFExtendedRuntime.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			EEFExtendedRuntime.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				EEFExtendedRuntime.INSTANCE.getString("UI_InteractiveEEFEditor_menu"),
				"fr.obeo.eef.runtime.extended.InteractiveEEFEditorMenuID");
		...
		createChildMenuManager = new MenuManager(
				EEFExtendedRuntime.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(
				EEFExtendedRuntime.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	 ...
	 * can be added to the selected object and updating the menus accordingly.
	 */
