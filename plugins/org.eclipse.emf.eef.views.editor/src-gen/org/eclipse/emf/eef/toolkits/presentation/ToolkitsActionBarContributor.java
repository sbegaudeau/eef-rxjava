 ...
 * 
 *
 * $Id: ToolkitsActionBarContributor.java,v 1.2 2009/06/09 15:47:43 sbouchet Exp $
 */
 ...
 * @generated
 */
public class ToolkitsActionBarContributor extends
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		//
		createChildMenuManager = new MenuManager(ViewsEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(ViewsEditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(ViewsEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
