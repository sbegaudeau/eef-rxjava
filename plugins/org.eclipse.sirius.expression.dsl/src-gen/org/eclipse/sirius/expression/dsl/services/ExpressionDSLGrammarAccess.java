 ...
 * generated by Xtext
 */
package org.eclipse.sirius.expression.dsl.services;
...
public class ExpressionDSLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class SiriusExpressionPackageElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.SiriusExpressionPackage");
		...
		private final RuleCall cEPackageEPackageFQNParserRuleCall_1_0_1 = (RuleCall)cEPackageEPackageCrossReference_1_0.eContents().get(1);
		...
		//'package' ePackage=[ecore::EPackage|FQN] '{' expressionClasses+=SiriusExpressionClass* '}'
		public Group getGroup() { return cGroup; }

		//'package'
		public Keyword getPackageKeyword_0() { return cPackageKeyword_0; }

		//ePackage=[ecore::EPackage|FQN]
		...
		//FQN
		public RuleCall getEPackageEPackageFQNParserRuleCall_1_0_1() { return cEPackageEPackageFQNParserRuleCall_1_0_1; }
	...
	public class SiriusExpressionClassElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.SiriusExpressionClass");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SiriusVariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.SiriusVariable");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FQNElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.FQN");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SiriusExpressionDescriptionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.SiriusExpressionDescription");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final CrossReference cTypeEClassifierCrossReference_6_0 = (CrossReference)cTypeAssignment_6.eContents().get(0);
		private final RuleCall cTypeEClassifierFQNParserRuleCall_6_0_1 = (RuleCall)cTypeEClassifierCrossReference_6_0.eContents().get(1);
		...
		private final Keyword cContextableElementsKeyword_13 = (Keyword)cGroup.eContents().get(13);
		...
		private final Assignment cContextableElementsAssignment_16_0 = (Assignment)cGroup_16.eContents().get(0);
		private final CrossReference cContextableElementsEClassCrossReference_16_0_0 = (CrossReference)cContextableElementsAssignment_16_0.eContents().get(0);
		private final RuleCall cContextableElementsEClassFQNParserRuleCall_16_0_0_1 = (RuleCall)cContextableElementsEClassCrossReference_16_0_0.eContents().get(1);
		...
		private final Assignment cContextableElementsAssignment_16_1_1 = (Assignment)cGroup_16_1.eContents().get(1);
		private final CrossReference cContextableElementsEClassCrossReference_16_1_1_0 = (CrossReference)cContextableElementsAssignment_16_1_1.eContents().get(0);
		private final RuleCall cContextableElementsEClassFQNParserRuleCall_16_1_1_0_1 = (RuleCall)cContextableElementsEClassCrossReference_16_1_1_0.eContents().get(1);
		private final Keyword cRightSquareBracketKeyword_17 = (Keyword)cGroup.eContents().get(17);
		private final Keyword cRightCurlyBracketKeyword_18 = (Keyword)cGroup.eContents().get(18);
		
		//SiriusExpressionDescription:
		//	'exp' expression=[ecore::EAttribute|FQN] '(' (parameters+=Parameter (',' parameters+=Parameter)*)? ')' ':'
		//	type=[ecore::EClassifier|FQN] '[' lowerBound=Bound '..' upperBound=Bound ']' '{'
		//	'contextableElements' '=' '[' (contextableElements+=[ecore::EClass|FQN] (','
		//	contextableElements+=[ecore::EClass|FQN])*)?
		//	']'
		//	'}';
		@Override public ParserRule getRule() { return rule; }

		//'exp' expression=[ecore::EAttribute|FQN] '(' (parameters+=Parameter (',' parameters+=Parameter)*)? ')' ':'
		//type=[ecore::EClassifier|FQN] '[' lowerBound=Bound '..' upperBound=Bound ']' '{' 'contextableElements' '=' '['
		...
		//[ecore::EClassifier|FQN]
		public CrossReference getTypeEClassifierCrossReference_6_0() { return cTypeEClassifierCrossReference_6_0; }

		//FQN
		public RuleCall getTypeEClassifierFQNParserRuleCall_6_0_1() { return cTypeEClassifierFQNParserRuleCall_6_0_1; }
		...
		//'contextableElements'
		public Keyword getContextableElementsKeyword_13() { return cContextableElementsKeyword_13; }
		...
		//contextableElements+=[ecore::EClass|FQN]
		public Assignment getContextableElementsAssignment_16_0() { return cContextableElementsAssignment_16_0; }

		//[ecore::EClass|FQN]
		public CrossReference getContextableElementsEClassCrossReference_16_0_0() { return cContextableElementsEClassCrossReference_16_0_0; }

		//FQN
		public RuleCall getContextableElementsEClassFQNParserRuleCall_16_0_0_1() { return cContextableElementsEClassFQNParserRuleCall_16_0_0_1; }
		...
		//contextableElements+=[ecore::EClass|FQN]
		public Assignment getContextableElementsAssignment_16_1_1() { return cContextableElementsAssignment_16_1_1; }

		//[ecore::EClass|FQN]
		public CrossReference getContextableElementsEClassCrossReference_16_1_1_0() { return cContextableElementsEClassCrossReference_16_1_1_0; }

		//FQN
		public RuleCall getContextableElementsEClassFQNParserRuleCall_16_1_1_0_1() { return cContextableElementsEClassFQNParserRuleCall_16_1_1_0_1; }
	...
	public class ParameterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.Parameter");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final RuleCall cVariableSiriusVariableFQNParserRuleCall_1_0_1 = (RuleCall)cVariableSiriusVariableCrossReference_1_0.eContents().get(1);
		...
		//FQN
		public RuleCall getVariableSiriusVariableFQNParserRuleCall_1_0_1() { return cVariableSiriusVariableFQNParserRuleCall_1_0_1; }
	}

	public class BoundElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.Bound");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public ExpressionDSLGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.tID = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.ID");
		this.tINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.INT");
		this.tML_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.ML_COMMENT");
		this.tWS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.expression.dsl.ExpressionDSL.WS");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("org.eclipse.sirius.expression.dsl.ExpressionDSL".equals(grammar.getName())) {
				return grammar;
			}
