...
public class ContextPackageImpl extends EPackageImpl implements ContextPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getContextVariable_Name(), ecorePackage.getEString(), "name", null, 0, 1, ContextVariable.class, //$NON-NLS-1$
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getContextVariable_Documentation(), ecorePackage.getEString(), "documentation", null, 0, 1, //$NON-NLS-1$
